...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../">
  <title>
   Metronic - Tailwind CSS Get Started
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/network/get-started" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Get started with network management, powered by Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Get Started" name="twitter:title"/>
  <meta content="Get started with network management, powered by Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/network/get-started" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Get Started" property="og:title"/>
  <meta content="Get started with network management, powered by Tailwind CSS" property="og:description"/>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-7.5">
         <div class="card p-5 lg:px-7 lg:py-6">
          <div class="flex flex-col gap-2.5">
           <i class="ki-filled ki-user-square text-2xl text-primary mb-1.5">
           </i>
           ...
           <div class="flex items-center flex-wrap">
            <a class="text-2sm font-medium text-primary hover:text-primary mb-1" href="html/demo10/network/user-cards/mini-cards.html">
             Mini Cards
            </a>
            <span class="h-3.5 border-s border-s-gray-300 last-of-type:hidden mx-2 mb-1">
            </span>
            <a class="text-2sm font-medium text-primary hover:text-primary mb-1" href="html/demo10/account/members/team-members.html">
             Team Members
            </a>
            <span class="h-3.5 border-s border-s-gray-300 last-of-type:hidden mx-2 mb-1">
            </span>
            <a class="text-2sm font-medium text-primary hover:text-primary mb-1" href="html/demo10/network/user-cards/author.html">
             Athor
            </a>
            <span class="h-3.5 border-s border-s-gray-300 last-of-type:hidden mx-2 mb-1">
            </span>
            <a class="text-2sm font-medium text-primary hover:text-primary mb-1" href="html/demo10/network/user-cards/nft.html">
             NFT
            </a>
            <span class="h-3.5 border-s border-s-gray-300 last-of-type:hidden mx-2 mb-1">
            </span>
            <a class="text-2sm font-medium text-primary hover:text-primary mb-1" href="html/demo10/network/user-cards/social.html">
             Social
            </a>
            <span class="h-3.5 border-s border-s-gray-300 last-of-type:hidden mx-2 mb-1">
            </span>
         ...
         <div class="card p-5 lg:px-7 lg:py-6">
          <div class="flex flex-col gap-2.5">
           <i class="ki-filled ki-subtitle text-2xl text-primary mb-1.5">
           </i>
           <div class="flex flex-col gap-3">
            <h3 class="text-base font-medium leading-none text-gray-900">
             User Base
           ...
           <div class="flex items-center flex-wrap">
            <a class="text-2sm font-medium text-primary hover:text-primary mb-1" href="html/demo10/network/user-cards/team-crew.html">
             Team Crew
            </a>
            <span class="h-3.5 border-s border-s-gray-300 last-of-type:hidden mx-2 mb-1">
            </span>
            <a class="text-2sm font-medium text-primary hover:text-primary mb-1" href="html/demo10/user-table/app-roster.html">
             App Roster
            </a>
            <span class="h-3.5 border-s border-s-gray-300 last-of-type:hidden mx-2 mb-1">
            </span>
            <a class="text-2sm font-medium text-primary hover:text-primary mb-1" href="html/demo10/network/user-table/visitors.html">
             Visitor
            </a>
            <span class="h-3.5 border-s border-s-gray-300 last-of-type:hidden mx-2 mb-1">
            </span>
            ...
            <a class="text-2sm font-medium text-primary hover:text-primary mb-1" href="html/demo10/network/user-table/saas-users.html">
             SaaS Users
            </a>
            <span class="h-3.5 border-s border-s-gray-300 last-of-type:hidden mx-2 mb-1">
            </span>
            <a class="text-2sm font-medium text-primary hover:text-primary mb-1" href="html/demo10/network/user-table/store-clients.html">
             Store Clients
            </a>
            <span class="h-3.5 border-s border-s-gray-300 last-of-type:hidden mx-2 mb-1">
            </span>
         ...
         <div class="card p-5 lg:px-7 lg:py-6">
          <div class="flex flex-col gap-2.5">
           <i class="ki-filled ki-key-square text-2xl text-primary mb-1.5">
           </i>
           <div class="flex flex-col gap-3">
            <h3 class="text-base font-medium leading-none text-gray-900">
             Cooperators
           ...
           <div class="flex items-center flex-wrap">
            <a class="text-2sm font-medium text-primary hover:text-primary mb-1" href="html/demo10/account/members/roles.html">
             Contacts
            </a>
            <span class="h-3.5 border-s border-s-gray-300 last-of-type:hidden mx-2 mb-1">
            </span>
            ...
            <a class="text-2sm font-medium text-primary hover:text-primary mb-1" href="html/demo10/network/user-table/market-authors.html">
             Vendors
            </a>
            <span class="h-3.5 border-s border-s-gray-300 last-of-type:hidden mx-2 mb-1">
            </span>
            <a class="text-2sm font-medium text-primary hover:text-primary mb-1" href="html/demo10/public-profile/profiles/company.html">
             Companies
            </a>
            <span class="h-3.5 border-s border-s-gray-300 last-of-type:hidden mx-2 mb-1">
            </span>
            <a class="text-2sm font-medium text-primary hover:text-primary mb-1" href="html/demo10/account/api-keys.html">
             Service Agents
            </a>
            <span class="h-3.5 border-s border-s-gray-300 last-of-type:hidden mx-2 mb-1">
            </span>
         ...
         <div class="card p-5 lg:px-7 lg:py-6">
          <div class="flex flex-col gap-2.5">
           <i class="ki-filled ki-chart-pie-3 text-2xl text-primary mb-1.5">
           </i>
           <div class="flex flex-col gap-3">
            <h3 class="text-base font-medium leading-none text-gray-900">
         ...
         <div class="card p-5 lg:px-7 lg:py-6">
          <div class="flex flex-col gap-2.5">
           <i class="ki-filled ki-calendar-tick text-2xl text-primary mb-1.5">
           </i>
           <div class="flex flex-col gap-3">
            <h3 class="text-base font-medium leading-none text-gray-900">
             Donatiors
