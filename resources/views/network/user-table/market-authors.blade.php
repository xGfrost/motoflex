...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Market Authors
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/network/user-table/market-authors" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Market authors table, styled with Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Market Authors" name="twitter:title"/>
  <meta content="Market authors table, styled with Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/network/user-table/market-authors" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Market Authors" property="og:title"/>
  <meta content="Market authors table, styled with Tailwind CSS" property="og:description"/>
             ...
             <table class="table table-auto table-border" data-datatable-table="true">
              ...
              <tbody>
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-1.5 font-normal text-gray-800">
                  <img alt="" class="w-5" src="assets/media/brand-logos/weave.svg"/>
                  Tech Titans
                 </div>
                </td>
                <td class="font-normal text-gray-800">
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <a href="">
                   <i class="ki-filled ki-facebook text-gray-500 text-lg">
                   </i>
                  </a>
                  <a href="">
                   <i class="ki-filled ki-dribbble text-gray-500 text-lg">
                   </i>
                  </a>
                  <a href="">
                   <i class="ki-filled ki-tiktok text-gray-500 text-lg">
                   </i>
                  </a>
                 </div>
                </td>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-1.5 font-normal text-gray-800">
                  <img alt="" class="w-5" src="assets/media/brand-logos/monetha.svg"/>
                  Creative Minds
                 </div>
                </td>
                <td class="font-normal text-gray-800">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-1.5 font-normal text-gray-800">
                  <img alt="" class="w-5" src="assets/media/brand-logos/foursquare.svg"/>
                  Code Crafters
                 </div>
                </td>
                <td class="font-normal text-gray-800">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-1.5 font-normal text-gray-800">
                  <img alt="" class="w-5" src="assets/media/brand-logos/flood-io.svg"/>
                  Market Movers
                 </div>
                </td>
                <td class="font-normal text-gray-800">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-5.png"/>
                  <div class="flex flex-col">
                   <a class="text-sm font-medium text-gray-900 hover:text-primary-active mb-px" href="#">
                    Leslie Alexander
                   </a>
                ...
                <td>
                 <div class="flex items-center gap-1.5 font-normal text-gray-800">
                  <img alt="" class="w-5" src="assets/media/brand-logos/gitlab.svg"/>
                  Brand Builders
                 </div>
                </td>
                <td class="font-normal text-gray-800">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-1.5 font-normal text-gray-800">
                  <img alt="" class="w-5" src="assets/media/brand-logos/btcchina.svg"/>
                  Data Pioneers
                 </div>
                </td>
                <td class="font-normal text-gray-800">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-1.5 font-normal text-gray-800">
                  <img alt="" class="w-5" src="assets/media/brand-logos/bridgefy.svg"/>
                  Talent Scouts
                 </div>
                </td>
                <td class="font-normal text-gray-800">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-1.5 font-normal text-gray-800">
                  <img alt="" class="w-5" src="assets/media/brand-logos/the-ocean.svg"/>
                  Revenue Raisers
                 </div>
                </td>
                <td class="font-normal text-gray-800">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-1.5 font-normal text-gray-800">
                  <img alt="" class="w-5" src="assets/media/brand-logos/xing.svg"/>
                  Vision Guides
                 </div>
                </td>
                <td class="font-normal text-gray-800">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-1.5 font-normal text-gray-800">
                  <img alt="" class="w-5" src="assets/media/brand-logos/voise.svg"/>
                  Web Wizards
                 </div>
                </td>
                <td class="font-normal text-gray-800">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-1.5 font-normal text-gray-800">
                  <img alt="" class="w-5" src="assets/media/brand-logos/google-analytics.svg"/>
                  Security Squad
                 </div>
                </td>
                <td class="font-normal text-gray-800">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-1.5 font-normal text-gray-800">
                  <img alt="" class="w-5" src="assets/media/brand-logos/slack.svg"/>
                  Content Creators
                 </div>
                </td>
                <td class="font-normal text-gray-800">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-1.5 font-normal text-gray-800">
                  <img alt="" class="w-5" src="assets/media/brand-logos/jira.svg"/>
                  Design Dynamos
                 </div>
                </td>
                <td class="font-normal text-gray-800">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-1.5 font-normal text-gray-800">
                  <img alt="" class="w-5" src="assets/media/brand-logos/twitch-purple.svg"/>
                  Market Masters
                 </div>
                </td>
                <td class="font-normal text-gray-800">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-1.5 font-normal text-gray-800">
                  <img alt="" class="w-5" src="assets/media/brand-logos/invision.svg"/>
                  Success Stars
                 </div>
                </td>
                <td class="font-normal text-gray-800">
