...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS App Roster
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/network/user-table/app-roster" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="App roster table, using Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS App Roster" name="twitter:title"/>
  <meta content="App roster table, using Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/network/user-table/app-roster" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS App Roster" property="og:title"/>
  <meta content="App roster table, using Tailwind CSS" property="og:description"/>
             ...
             <table class="table table-auto table-border" data-datatable-table="true">
              ...
              <tbody>
               <tr>
                ...
                <td>
                 <div class="flex flex-wrap gap-2">
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/slack.svg"/>
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/twitch-purple.svg"/>
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/invision.svg"/>
                 </div>
                </td>
                <td>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-23.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Jane Smith
                  </a>
                 </div>
                ...
                <td>
                 <div class="flex flex-wrap gap-2">
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/google-analytics.svg"/>
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/google-calendar.svg"/>
                 </div>
                </td>
                <td>
                 <div class="flex flex-wrap gap-1.5">
               ...
               <tr>
                ...
                <td>
                 <div class="flex flex-wrap gap-2">
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/tiktok-2.svg"/>
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/monetha.svg"/>
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/twitch-purple.svg"/>
                 </div>
                </td>
                <td>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-14.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Michael Brown
                  </a>
                 </div>
                ...
                <td>
                 <div class="flex flex-wrap gap-2">
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/x.svg"/>
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/instagram-2.svg"/>
                 </div>
                </td>
                <td>
                 <div class="flex flex-wrap gap-1.5">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-19.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Chloe Davis
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-6.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   William Wilson
                  </a>
                 </div>
                ...
                <td>
                 <div class="flex flex-wrap gap-2">
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/jira.svg"/>
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/slack.svg"/>
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/google-webdev.svg"/>
                 </div>
                </td>
                <td>
                 <div class="flex flex-wrap gap-1.5">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-34.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Olivia Martin
                  </a>
                 </div>
                ...
                <td>
                 <div class="flex flex-wrap gap-2">
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/azure.svg"/>
                 </div>
                </td>
                <td>
                 <div class="flex flex-wrap gap-1.5">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-4.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Ethan Garcia
                  </a>
                 </div>
                ...
                <td>
                 <div class="flex flex-wrap gap-2">
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/facebook.svg"/>
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/weave.svg"/>
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/plastic-scm.svg"/>
                 </div>
                </td>
                <td>
                 <div class="flex flex-wrap gap-1.5">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-13.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Ava Rodriguez
                  </a>
                 </div>
                ...
                <td>
                 <div class="flex flex-wrap gap-2">
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/sololearn.svg"/>
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/twitch-purple.svg"/>
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/linkedin.svg"/>
                  <img alt="" class="size-[18px] shrinc-0" src="assets/media/brand-logos/office.svg"/>
                 </div>
                </td>
                <td>
                 <div class="flex flex-wrap gap-1.5">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-31.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Matthew Martinez
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-7.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Sophia Anderson
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-8.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Mason Taylor
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-9.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Isabella Lee
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-10.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   James Martinez
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-12.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Benjamin Harris
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-15.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Charlotte Young
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-16.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Henry Clark
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-17.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Amelia Lewis
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-18.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Lucas Walker
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-20.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Harper White
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-21.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Jack Harris
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-22.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Grace Allen
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-24.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Aiden King
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-25.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Avery Green
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-26.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Ella White
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-27.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Henry King
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-28.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Olivia Green
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-29.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Mason Lewis
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-30.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Sophia Lee
                  </a>
                 </div>
