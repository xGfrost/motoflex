...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Visitors
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/network/user-table/visitors" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Visitors table, styled with Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Visitors" name="twitter:title"/>
  <meta content="Visitors table, styled with Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/network/user-table/visitors" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Visitors" property="og:title"/>
  <meta content="Visitors table, styled with Tailwind CSS" property="og:description"/>
             ...
             <table class="table table-auto table-border" data-datatable-table="true">
              ...
              <tbody>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-32.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Noah Wilson
                  </a>
                 </div>
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-2.5">
                  <img alt="" class="rounded-full size-7 shrink-0" src="assets/media/avatars/300-33.png"/>
                  <a class="text-sm font-medium text-gray-900 hover:text-primary-active" href="#">
                   Mia Brown
                  </a>
                 </div>
