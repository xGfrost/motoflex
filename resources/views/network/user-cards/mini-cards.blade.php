...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Mini Cards
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/network/user-cards/mini-cards" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Mini user cards layout, using Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Mini Cards" name="twitter:title"/>
  <meta content="Mini user cards layout, using Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/network/user-cards/mini-cards" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Mini Cards" property="og:title"/>
  <meta content="Mini user cards layout, using Tailwind CSS" property="og:description"/>
       ...
       <div class="container-fixed">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 lg:gap-7.5">
         ...
         <div class="card flex flex-col items-center p-5 lg:py-10">
          <div class="mb-3.5">
           <div class="size-20 relative">
            <img class="rounded-full" src="assets/media/avatars/300-4.png"/>
            <div class="flex size-2.5 bg-success rounded-full absolute bottom-0.5 start-16 transform -translate-y-1/2">
            </div>
           </div>
          </div>
         ...
         <div class="card flex flex-col items-center p-5 lg:py-10">
          <div class="mb-3.5">
           <div class="size-20 relative">
            <img class="rounded-full" src="assets/media/avatars/300-13.png"/>
            <div class="flex size-2.5 bg-gray-400 rounded-full absolute bottom-0.5 start-16 transform -translate-y-1/2">
            </div>
           </div>
          </div>
         ...
         <div class="card flex flex-col items-center p-5 lg:py-10">
          <div class="mb-3.5">
           <div class="size-20 relative">
            <img class="rounded-full" src="assets/media/avatars/300-23.png"/>
            <div class="flex size-2.5 bg-success rounded-full absolute bottom-0.5 start-16 transform -translate-y-1/2">
            </div>
           </div>
          </div>
         ...
         <div class="card flex flex-col items-center p-5 lg:py-10">
          <div class="mb-3.5">
           <div class="flex items-center justify-center relative text-2.5xl text-warning size-20 ring-1 ring-warning-clarity bg-warning-light rounded-full">
            J
            <div class="flex size-2.5 bg-success rounded-full absolute bottom-0.5 start-16 transform -translate-y-1/2">
            </div>
           </div>
         ...
         <div class="card flex flex-col items-center p-5 lg:py-10">
          ...
          <a class="text-gray-700 text-sm hover:text-primary-active" href="#">
           betterthanvettel.eth
          </a>
         </div>
        </div>
        <div class="flex grow justify-center pt-5 lg:pt-7.5">
         <a class="btn btn-link" href="html/demo10/account/home/user-profile.html">
          Show more Users
         </a>
        </div>
       </div>
