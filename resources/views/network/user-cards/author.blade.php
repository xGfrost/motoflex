...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Author
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/network/user-cards/author" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Author profile cards, styled with Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Author" name="twitter:title"/>
  <meta content="Author profile cards, styled with Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/network/user-cards/author" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Author" property="og:title"/>
  <meta content="Author profile cards, styled with Tailwind CSS" property="og:description"/>
        ...
        <div class="flex flex-col items-stretch gap-5 lg:gap-7.5">
         <div class="flex flex-wrap items-center gap-5 justify-between">
          ...
          <div class="flex items-center flex-wrap gap-5">
           ...
           <div class="btn-tabs btn-tabs-sm" data-tabs="true">
            <a class="btn btn-icon active" data-tab-toggle="#author_cards" href="#">
             <i class="ki-filled ki-category">
             </i>
            </a>
            <a class="btn btn-icon" data-tab-toggle="#author_list" href="#">
         ...
         <div class="flex flex-col gap-5 lg:gap-7.5" id="author_cards">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-7.5">
           <div class="card">
            <div class="card-header p-0 bg-no-repeat bg-cover bg-center card-rounded-t h-40" style="background-image: url('assets/media/images/2600x1200/bg-7.png')">
            </div>
            <div class="card-body mb-7.5 p-0">
             <div class="flex transform -translate-y-1/2 px-5 lg:px-7.5 gap-1.5">
              <div class="size-[120px] [.authors-row_&]:size-[80px] shrink-0 relative">
               <img class="rounded-full" src="assets/media/avatars/300-1.png"/>
               <div class="flex size-3 bg-success rounded-full ring-2 ring-light absolute bottom-2 start-[93px] [.authors-row_&]:start-[64px]">
               </div>
              </div>
             ...
             <div class="flex gap-5 scrollable-x -mt-8 ms-7.5">
              <div class="card mb-4 border-0 last:me-5">
               <div class="bg-cover bg-no-repeat card-rounded-t w-[240px] shrink-0 h-44" style="background-image: url('assets/media/images/600x600/6.jpg')">
               </div>
               <div class="card-border card-rounded-b px-3.5 pt-5 pb-2.5">
                <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                 Geometric Patterns
                </a>
              ...
              <div class="card mb-4 border-0 last:me-5">
               <div class="bg-cover bg-no-repeat card-rounded-t w-[240px] shrink-0 h-44" style="background-image: url('assets/media/images/600x600/7.jpg')">
               </div>
               <div class="card-border card-rounded-b px-3.5 pt-5 pb-2.5">
                <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                 Artistic Expressions
              ...
              <div class="card mb-4 border-0 last:me-5">
               <div class="bg-cover bg-no-repeat card-rounded-t w-[240px] shrink-0 h-44" style="background-image: url('assets/media/images/600x600/24.jpg')">
               </div>
               <div class="card-border card-rounded-b px-3.5 pt-5 pb-2.5">
                <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                 Duolingo Tech Hub
              ...
              <div class="card mb-4 border-0 last:me-5">
               <div class="bg-cover bg-no-repeat card-rounded-t w-[240px] shrink-0 h-44" style="background-image: url('assets/media/images/600x600/27.jpg')">
               </div>
               <div class="card-border card-rounded-b px-3.5 pt-5 pb-2.5">
                <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                 Duolingo Language
            ...
            <div class="card-footer justify-center">
             <a class="btn btn-link" href="html/demo10/account/members/team-members.html">
              View Profile
             </a>
            </div>
           </div>
           <div class="card">
            <div class="card-header p-0 bg-no-repeat bg-cover bg-center card-rounded-t h-40" style="background-image: url('assets/media/images/2600x1200/bg-8.png')">
            </div>
            <div class="card-body mb-7.5 p-0">
             <div class="flex transform -translate-y-1/2 px-5 lg:px-7.5 gap-1.5">
              <div class="size-[120px] [.authors-row_&]:size-[80px] shrink-0 relative">
               <img class="rounded-full" src="assets/media/avatars/300-3.png"/>
               <div class="flex size-3 bg-success rounded-full ring-2 ring-light absolute bottom-2 start-[93px] [.authors-row_&]:start-[64px]">
               </div>
              </div>
              <div class="flex flex-col justify-end grow">
             ...
             <div class="flex gap-5 scrollable-x -mt-8 ms-7.5">
              <div class="card mb-4 border-0 last:me-5">
               <div class="bg-cover bg-no-repeat card-rounded-t w-[240px] shrink-0 h-44" style="background-image: url('assets/media/images/600x600/1.jpg')">
               </div>
               <div class="card-border card-rounded-b px-3.5 pt-5 pb-2.5">
                <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                 Geometric Patterns
              ...
              <div class="card mb-4 border-0 last:me-5">
               <div class="bg-cover bg-no-repeat card-rounded-t w-[240px] shrink-0 h-44" style="background-image: url('assets/media/images/600x600/25.jpg')">
               </div>
               <div class="card-border card-rounded-b px-3.5 pt-5 pb-2.5">
                <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                 Artistic Expressions
              ...
              <div class="card mb-4 border-0 last:me-5">
               <div class="bg-cover bg-no-repeat card-rounded-t w-[240px] shrink-0 h-44" style="background-image: url('assets/media/images/600x600/3.jpg')">
               </div>
               <div class="card-border card-rounded-b px-3.5 pt-5 pb-2.5">
                <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                 Geometric Patterns
              ...
              <div class="card mb-4 border-0 last:me-5">
               <div class="bg-cover bg-no-repeat card-rounded-t w-[240px] shrink-0 h-44" style="background-image: url('assets/media/images/600x600/5.jpg')">
               </div>
               <div class="card-border card-rounded-b px-3.5 pt-5 pb-2.5">
                <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                 Geometric Patterns
           ...
           <div class="card">
            <div class="card-header p-0 bg-no-repeat bg-cover bg-center card-rounded-t h-40" style="background-image: url('assets/media/images/2600x1200/bg-9.png')">
            </div>
            <div class="card-body mb-7.5 p-0">
             <div class="flex transform -translate-y-1/2 px-5 lg:px-7.5 gap-1.5">
              <div class="size-[120px] [.authors-row_&]:size-[80px] shrink-0 relative">
               <img class="rounded-full" src="assets/media/avatars/300-17.png"/>
               <div class="flex size-3 bg-gray-400 rounded-full ring-2 ring-light absolute bottom-2 start-[93px] [.authors-row_&]:start-[64px]">
               </div>
              </div>
              <div class="flex flex-col justify-end grow">
               <div class="flex items-center justify-between flex-wrap gap-2">
             ...
             <div class="flex gap-5 scrollable-x -mt-8 ms-7.5">
              ...
              <div class="card mb-4 border-0 last:me-5">
               <div class="bg-cover bg-no-repeat card-rounded-t w-[240px] shrink-0 h-44" style="background-image: url('assets/media/images/600x600/28.jpg')">
               </div>
               <div class="card-border card-rounded-b px-3.5 pt-5 pb-2.5">
                <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                 Artistic Expressions
              ...
              <div class="card mb-4 border-0 last:me-5">
               <div class="bg-cover bg-no-repeat card-rounded-t w-[240px] shrink-0 h-44" style="background-image: url('assets/media/images/600x600/29.jpg')">
               </div>
               <div class="card-border card-rounded-b px-3.5 pt-5 pb-2.5">
                <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                 Geometric Patterns
           ...
           <div class="card">
            <div class="card-header p-0 bg-no-repeat bg-cover bg-center card-rounded-t h-40" style="background-image: url('assets/media/images/2600x1200/bg-10.png')">
            </div>
            <div class="card-body mb-7.5 p-0">
             <div class="flex transform -translate-y-1/2 px-5 lg:px-7.5 gap-1.5">
              <div class="size-[120px] [.authors-row_&]:size-[80px] shrink-0 relative">
               <img class="rounded-full" src="assets/media/avatars/300-5.png"/>
               <div class="flex size-3 bg-gray-400 rounded-full ring-2 ring-light absolute bottom-2 start-[93px] [.authors-row_&]:start-[64px]">
               </div>
              </div>
              <div class="flex flex-col justify-end grow">
             ...
             <div class="flex gap-5 scrollable-x -mt-8 ms-7.5">
              <div class="card mb-4 border-0 last:me-5">
               <div class="bg-cover bg-no-repeat card-rounded-t w-[240px] shrink-0 h-44" style="background-image: url('assets/media/images/600x600/30.jpg')">
               </div>
               <div class="card-border card-rounded-b px-3.5 pt-5 pb-2.5">
                <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                 Geometric Patterns
              ...
              <div class="card mb-4 border-0 last:me-5">
               <div class="bg-cover bg-no-repeat card-rounded-t w-[240px] shrink-0 h-44" style="background-image: url('assets/media/images/600x600/31.jpg')">
               </div>
               <div class="card-border card-rounded-b px-3.5 pt-5 pb-2.5">
                <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                 Artistic Expressions
              ...
              <div class="card mb-4 border-0 last:me-5">
               <div class="bg-cover bg-no-repeat card-rounded-t w-[240px] shrink-0 h-44" style="background-image: url('assets/media/images/600x600/32.jpg')">
               </div>
               <div class="card-border card-rounded-b px-3.5 pt-5 pb-2.5">
                <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                 Geometric Patterns
         ...
         <div class="authors-row hidden" id="author_list">
          <div class="grid grid-cols-1 gap-5 lg:gap-7.5">
           <div class="card">
            <div class="card-body flex flex-wrap gap-5 items-center justify-between">
             <div class="flex items-center flex-wrap gap-3.5">
              ...
              <div class="flex flex-col gap-1.5">
               ...
               <span class="flex items-center text-gray-700 text-sm">
                <i class="ki-filled ki-geolocation me-1.5 text-mdtext-gray-500">
                </i>
                Houston, Texas
               </span>
              </div>
             ...
             <div class="flex items-center flex-wrap gap-5 lg:gap-12">
              <div class="card p-2.5">
               <div class="scrollable-x">
                <div class="flex items-center gap-7.5 w-80 mb-2">
                 <div class="flex items-center gap-3.5 min-w-64 last:mr-5">
                  <div class="rounded-md bg-no-repeat bg-cover min-w-24 max-w-24 h-12 shrink-0" style="background-image: url('assets/media/images/600x600/6.jpg')">
                  </div>
                  <div class="flex flex-col">
                   <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                    Geometric Patterns
                 ...
                 <div class="flex items-center gap-3.5 min-w-64 last:mr-5">
                  <div class="rounded-md bg-no-repeat bg-cover min-w-24 max-w-24 h-12 shrink-0" style="background-image: url('assets/media/images/600x600/7.jpg')">
                  </div>
                  <div class="flex flex-col">
                   <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                    Artistic Expressions
                 ...
                 <div class="flex items-center gap-3.5 min-w-64 last:mr-5">
                  <div class="rounded-md bg-no-repeat bg-cover min-w-24 max-w-24 h-12 shrink-0" style="background-image: url('assets/media/images/600x600/24.jpg')">
                  </div>
                  <div class="flex flex-col">
                   <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                    Duolingo Tech Hub
                 ...
                 <div class="flex items-center gap-3.5 min-w-64 last:mr-5">
                  <div class="rounded-md bg-no-repeat bg-cover min-w-24 max-w-24 h-12 shrink-0" style="background-image: url('assets/media/images/600x600/27.jpg')">
                  </div>
                  <div class="flex flex-col">
                   <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                    Duolingo Language
             ...
             <div class="flex items-center flex-wrap gap-5 lg:gap-12">
              <div class="card p-2.5">
               <div class="scrollable-x">
                <div class="flex items-center gap-7.5 w-80 mb-2">
                 <div class="flex items-center gap-3.5 min-w-64 last:mr-5">
                  <div class="rounded-md bg-no-repeat bg-cover min-w-24 max-w-24 h-12 shrink-0" style="background-image: url('assets/media/images/600x600/1.jpg')">
                  </div>
                  <div class="flex flex-col">
                   <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                    Geometric Patterns
                 ...
                 <div class="flex items-center gap-3.5 min-w-64 last:mr-5">
                  <div class="rounded-md bg-no-repeat bg-cover min-w-24 max-w-24 h-12 shrink-0" style="background-image: url('assets/media/images/600x600/25.jpg')">
                  </div>
                  <div class="flex flex-col">
                   <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                    Artistic Expressions
                 ...
                 <div class="flex items-center gap-3.5 min-w-64 last:mr-5">
                  <div class="rounded-md bg-no-repeat bg-cover min-w-24 max-w-24 h-12 shrink-0" style="background-image: url('assets/media/images/600x600/3.jpg')">
                  </div>
                  <div class="flex flex-col">
                   <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                    Geometric Patterns
                 ...
                 <div class="flex items-center gap-3.5 min-w-64 last:mr-5">
                  <div class="rounded-md bg-no-repeat bg-cover min-w-24 max-w-24 h-12 shrink-0" style="background-image: url('assets/media/images/600x600/5.jpg')">
                  </div>
                  <div class="flex flex-col">
                   <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                    Geometric Patterns
              ...
              <div class="card p-2.5">
               <div class="scrollable-x">
                <div class="flex items-center gap-7.5 w-80 mb-2">
                 ...
                 <div class="flex items-center gap-3.5 min-w-64 last:mr-5">
                  <div class="rounded-md bg-no-repeat bg-cover min-w-24 max-w-24 h-12 shrink-0" style="background-image: url('assets/media/images/600x600/28.jpg')">
                  </div>
                  <div class="flex flex-col">
                   <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                    Artistic Expressions
                 ...
                 <div class="flex items-center gap-3.5 min-w-64 last:mr-5">
                  <div class="rounded-md bg-no-repeat bg-cover min-w-24 max-w-24 h-12 shrink-0" style="background-image: url('assets/media/images/600x600/29.jpg')">
                  </div>
                  <div class="flex flex-col">
                   <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                    Geometric Patterns
             ...
             <div class="flex items-center flex-wrap gap-5 lg:gap-12">
              <div class="card p-2.5">
               <div class="scrollable-x">
                <div class="flex items-center gap-7.5 w-80 mb-2">
                 <div class="flex items-center gap-3.5 min-w-64 last:mr-5">
                  <div class="rounded-md bg-no-repeat bg-cover min-w-24 max-w-24 h-12 shrink-0" style="background-image: url('assets/media/images/600x600/30.jpg')">
                  </div>
                  <div class="flex flex-col">
                   <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                    Geometric Patterns
                 ...
                 <div class="flex items-center gap-3.5 min-w-64 last:mr-5">
                  <div class="rounded-md bg-no-repeat bg-cover min-w-24 max-w-24 h-12 shrink-0" style="background-image: url('assets/media/images/600x600/31.jpg')">
                  </div>
                  <div class="flex flex-col">
                   <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                    Artistic Expressions
                 ...
                 <div class="flex items-center gap-3.5 min-w-64 last:mr-5">
                  <div class="rounded-md bg-no-repeat bg-cover min-w-24 max-w-24 h-12 shrink-0" style="background-image: url('assets/media/images/600x600/32.jpg')">
                  </div>
                  <div class="flex flex-col">
                   <a class="font-medium block text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
                    Geometric Patterns
