...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Social
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/network/user-cards/social" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Social profile cards, powered by Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Social" name="twitter:title"/>
  <meta content="Social profile cards, powered by Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/network/user-cards/social" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Social" property="og:title"/>
  <meta content="Social profile cards, powered by Tailwind CSS" property="og:description"/>
      ...
      <main class="grow" role="content">
       ...
       <div class="container-fixed">
        <div class="flex flex-col items-stretch gap-5 lg:gap-7.5">
         <div class="flex flex-wrap items-center gap-5 justify-between">
          ...
          <div class="flex items-center flex-wrap gap-5">
           ...
           <div class="btn-tabs btn-tabs-sm" data-tabs="true">
            <a class="btn btn-icon active" data-tab-toggle="#social_card" href="#">
             <i class="ki-filled ki-category">
             </i>
            </a>
            <a class="btn btn-icon" data-tab-toggle="#social_list" href="#">
         ...
         <div class="flex flex-col gap-5 lg:gap-7.5" id="social_card">
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-7.5">
           <div class="card">
            <div class="card-body flex flex-col items-center lg:pt-10">
             <div class="mb-3">
             ...
             <div class="flex items-center gap-2.5">
              <a href="">
               <i class="ki-filled ki-facebook text-gray-600 text-lg">
               </i>
              </a>
              <a href="">
               <i class="ki-filled ki-dribbble text-gray-600 text-lg">
               </i>
              </a>
              <a href="">
               <i class="ki-filled ki-instagram text-gray-600 text-lg">
               </i>
              </a>
             </div>
            </div>
           ...
           <div class="card">
            <div class="card-body flex flex-col items-center lg:pt-10">
             <div class="mb-3">
              <div class="size-20 relative">
               <img class="rounded-full" src="assets/media/avatars/300-11.png"/>
               <div class="flex size-2.5 bg-success rounded-full ring-2 ring-light absolute bottom-0.5 start-16 transform -translate-y-1/2">
               </div>
              </div>
             </div>
           ...
           <div class="card">
            <div class="card-body flex flex-col items-center lg:pt-10">
             <div class="mb-3">
              <div class="size-20 relative">
               <img class="rounded-full" src="assets/media/avatars/300-30.png"/>
               <div class="flex size-2.5 bg-success rounded-full ring-2 ring-light absolute bottom-0.5 start-16 transform -translate-y-1/2">
               </div>
              </div>
             </div>
         ...
         <div class="hidden" id="social_list">
             ...
             <div class="flex items-center gap-3.5">
              ...
              <div class="flex flex-col gap-2">
               ...
               <div class="flex flex-wrap items-center gap-1.5">
                <i class="ki-filled ki-geolocation text-gray-500 text-md">
                </i>
