...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/network/user-cards/nft" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="NFT profile cards, using Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS NFT" name="twitter:title"/>
  <meta content="NFT profile cards, using Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/network/user-cards/nft" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS NFT" property="og:title"/>
  <meta content="NFT profile cards, using Tailwind CSS" property="og:description"/>
        ...
        <div class="flex flex-col items-stretch gap-5 lg:gap-7.5">
         ...
         <div id="network_cards">
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-7.5">
           <div class="card">
            <div class="card-header card-rounded-t flex justify-end items-start relative p-0 bg-no-repeat bg-cover bg-center h-[120px]" style="background-image: url('assets/media/images/2600x1200/bg-11.png')">
             <div class="menu mt-2.5 me-2.5" data-menu="true">
            ...
            <div class="card-body pt-0">
             <div class="flex justify-center transform -translate-y-1/2">
              <div class="size-20 shrink-0 relative">
               ...
               <div class="flex size-2.5 bg-success rounded-full ring-2 ring-light absolute bottom-0.5 start-16 transform -translate-y-1/2">
               </div>
              </div>
             </div>
             ...
             <div class="flex flex-wrap justify-center items-center gap-3.5 mb-7">
              <a class="text-xs text-gray-700 hover:text-primary-active" href="#">
               @jenny
              </a>
              <div class="flex items-center text-xs font-medium text-success">
               0x4aD5..F89Aa
               <i class="ki-filled ki-copy ms-1 text-gray-400 text-md">
               </i>
              </div>
             </div>
            ...
            <div class="card-footer justify-center">
             <a class="btn btn-link" href="html/demo10/public-profile/profiles/nft.html">
              View NFT’s
             </a>
            </div>
           </div>
           <div class="card">
            <div class="card-header card-rounded-t flex justify-end items-start relative p-0 bg-no-repeat bg-cover bg-center h-[120px]" style="background-image: url('assets/media/images/2600x1200/bg-12.png')">
             <div class="menu mt-2.5 me-2.5" data-menu="true">
              <div class="menu-item" data-menu-item-offset="0, 10px" data-menu-item-placement="bottom-end" data-menu-item-placement-rtl="bottom-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:click">
               <button class="menu-toggle btn btn-sm btn-icon text-gray-600 menu-item-show:text-gray-800 hover:text-gray-800">
                <i class="ki-filled ki-setting-2">
            ...
            <div class="card-body pt-0">
             <div class="flex justify-center transform -translate-y-1/2">
              <div class="flex items-center justify-center relative text-2.5xl text-danger size-20 ring-1 ring-danger-clarity bg-danger-light rounded-full">
               K
               <div class="flex size-2.5 bg-gray-400 rounded-full ring-2 ring-light absolute bottom-0.5 start-16 transform -translate-y-1/2">
               </div>
              </div>
             </div>
             <div class="flex items-center justify-center gap-1.5 mb-px -mt-7.5">
           ...
           <div class="card">
            <div class="card-header card-rounded-t flex justify-end items-start relative p-0 bg-no-repeat bg-cover bg-center h-[120px]" style="background-image: url('assets/media/images/2600x1200/bg-7.png')">
             <div class="menu mt-2.5 me-2.5" data-menu="true">
              <div class="menu-item" data-menu-item-offset="0, 10px" data-menu-item-placement="bottom-end" data-menu-item-placement-rtl="bottom-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:click">
               <button class="menu-toggle btn btn-sm btn-icon text-gray-600 menu-item-show:text-gray-800 hover:text-gray-800">
                <i class="ki-filled ki-setting-2">
            ...
            <div class="card-body pt-0">
             <div class="flex justify-center transform -translate-y-1/2">
              <div class="size-20 shrink-0 relative">
               <img class="rounded-full" src="assets/media/avatars/300-12.png"/>
               <div class="flex size-2.5 bg-gray-400 rounded-full ring-2 ring-light absolute bottom-0.5 start-16 transform -translate-y-1/2">
               </div>
              </div>
             </div>
           ...
           <div class="card">
            <div class="card-header card-rounded-t flex justify-end items-start relative p-0 bg-no-repeat bg-cover bg-center h-[120px]" style="background-image: url('assets/media/images/2600x1200/bg-10.png')">
             <div class="menu mt-2.5 me-2.5" data-menu="true">
              <div class="menu-item" data-menu-item-offset="0, 10px" data-menu-item-placement="bottom-end" data-menu-item-placement-rtl="bottom-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:click">
               <button class="menu-toggle btn btn-sm btn-icon text-gray-600 menu-item-show:text-gray-800 hover:text-gray-800">
                <i class="ki-filled ki-setting-2">
           ...
           <div class="card">
            <div class="card-header card-rounded-t flex justify-end items-start relative p-0 bg-no-repeat bg-cover bg-center h-[120px]" style="background-image: url('assets/media/images/2600x1200/bg-8.png')">
             <div class="menu mt-2.5 me-2.5" data-menu="true">
              <div class="menu-item" data-menu-item-offset="0, 10px" data-menu-item-placement="bottom-end" data-menu-item-placement-rtl="bottom-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:click">
               <button class="menu-toggle btn btn-sm btn-icon text-gray-600 menu-item-show:text-gray-800 hover:text-gray-800">
                <i class="ki-filled ki-setting-2">
            ...
            <div class="card-body pt-0">
             <div class="flex justify-center transform -translate-y-1/2">
              <div class="size-20 shrink-0 relative">
               <img class="rounded-full" src="assets/media/avatars/300-2.png"/>
               <div class="flex size-2.5 bg-gray-400 rounded-full ring-2 ring-light absolute bottom-0.5 start-16 transform -translate-y-1/2">
               </div>
              </div>
             </div>
           ...
           <div class="card">
            ...
            <div class="card-body pt-0">
             <div class="flex justify-center transform -translate-y-1/2">
              <div class="size-20 shrink-0 relative">
               <img class="rounded-full" src="assets/media/avatars/300-14.png"/>
               <div class="flex size-2.5 bg-success rounded-full ring-2 ring-light absolute bottom-0.5 start-16 transform -translate-y-1/2">
               </div>
              </div>
             </div>
           ...
           <div class="card">
            <div class="card-header card-rounded-t flex justify-end items-start relative p-0 bg-no-repeat bg-cover bg-center h-[120px]" style="background-image: url('assets/media/images/2600x1200/bg-13.png')">
             <div class="menu mt-2.5 me-2.5" data-menu="true">
              <div class="menu-item" data-menu-item-offset="0, 10px" data-menu-item-placement="bottom-end" data-menu-item-placement-rtl="bottom-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:click">
               <button class="menu-toggle btn btn-sm btn-icon text-gray-600 menu-item-show:text-gray-800 hover:text-gray-800">
                <i class="ki-filled ki-setting-2">
            ...
            <div class="flex items-center flex-wrap justify-between gap-5">
             <div class="flex items-center gap-3.5">
              ...
              <div class="flex flex-col gap-2">
               ...
               <div class="flex flex-wrap items-center gap-3.5">
                <a class="text-sm text-gray-700 hover:text-primary-active" href="#">
                 @jenny
                </a>
                <div class="flex items-center text-sm text-success">
                 0x4aD5..F89Aa
                 <i class="ki-filled ki-copy ms-1 text-gray-500 text-md">
                 </i>
                </div>
               </div>
              </div>
             ...
             <div class="flex items-center flex-wrap gap-5 lg:gap-12">
              <div class="flex items-center flex-wrap gap-2 lg:gap-5">
               <div class="grid grid-cols-1 gap-1.5 border border-dashed border-gray-300 shrink-0 rounded-md min-w-24 max-w-auto px-2.5 py-2">
                <span class="text-gray-900 text-sm leading-none font-medium">
                 196 ETH
                </span>
                <span class="text-gray-700 text-xs">
              ...
              <i class="ki-filled ki-setting-2 text-gray-600 text-lg">
              </i>
             </div>
            </div>
           </div>
