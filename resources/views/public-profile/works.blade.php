...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../">
  <title>
   Metronic - Tailwind CSS Works
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/works" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Works page featuring dynamic content, styled with Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Works" name="twitter:title"/>
  <meta content="Works page featuring dynamic content, styled with Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/works" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Works" property="og:title"/>
  <meta content="Works page featuring dynamic content, styled with Tailwind CSS" property="og:description"/>
   ...
   <div class="flex flex-col lg:flex-row grow pt-[--tw-header-height] lg:pt-0">
       ...
       <div class="bg-center bg-cover bg-no-repeat hero-bg">
        ...
        <div class="container-fixed">
         <div class="flex flex-col items-center gap-2 lg:gap-3.5 py-4 lg:pt-5 lg:pb-10">
          <img class="rounded-full border-3 border-success h-[100px] shrink-0" src="assets/media/avatars/300-1.png"/>
          <div class="flex items-center gap-1.5">
         ...
         <div id="works_cards">
          <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-7.5">
           <div class="card border-0">
            <img alt="" class="w-full h-auto rounded-t-xl" src="assets/media/images/600x400/21.jpg"/>
           ...
           <div class="card border-0">
            <img alt="" class="w-full h-auto rounded-t-xl" src="assets/media/images/600x400/22.jpg"/>
            <div class="card-border card-rounded-b flex flex-col gap-2 px-5 py-4.5">
             <a class="text-lg font-medium text-gray-900 hover:text-primary" href="html/demo10/public-profile/profiles/company.html">
              Golden Serenity
             </a>
           ...
           <div class="card border-0">
            <img alt="" class="w-full h-auto rounded-t-xl" src="assets/media/images/600x400/23.jpg"/>
            <div class="card-border card-rounded-b flex flex-col gap-2 px-5 py-4.5">
             <a class="text-lg font-medium text-gray-900 hover:text-primary" href="html/demo10/public-profile/profiles/company.html">
              Mystic Shadows
             </a>
           ...
           <div class="card border-0">
            <img alt="" class="w-full h-auto rounded-t-xl" src="assets/media/images/600x400/14.jpg"/>
            <div class="card-border card-rounded-b flex flex-col gap-2 px-5 py-4.5">
             <a class="text-lg font-medium text-gray-900 hover:text-primary" href="html/demo10/public-profile/profiles/company.html">
              Wild Beauty
             </a>
           ...
           <div class="card border-0">
            <img alt="" class="w-full h-auto rounded-t-xl" src="assets/media/images/600x400/25.jpg"/>
            <div class="card-border card-rounded-b flex flex-col gap-2 px-5 py-4.5">
             <a class="text-lg font-medium text-gray-900 hover:text-primary" href="html/demo10/public-profile/profiles/company.html">
              Timeless Elegance
             </a>
           ...
           <div class="card border-0">
            <img alt="" class="w-full h-auto rounded-t-xl" src="assets/media/images/600x400/26.jpg"/>
            <div class="card-border card-rounded-b flex flex-col gap-2 px-5 py-4.5">
             <a class="text-lg font-medium text-gray-900 hover:text-primary" href="html/demo10/public-profile/profiles/company.html">
              Intrepid Travel
             </a>
             <div class="flex items-center justify-between grow">
              <div class="flex items-center grow">
               <img alt="" class="rounded-full size-7 me-2" src="assets/media/avatars/300-25.png"/>
               <a class="text-2sm text-gray-800 hover:text-primary mb-px" href="html/demo10/public-profile/profiles/nft.html">
                Jhon Smith
               </a>
              </div>
           ...
           <div class="card border-0">
            ...
            <div class="card-border card-rounded-b flex flex-col gap-2 px-5 py-4.5">
             ...
             <div class="flex items-center justify-between grow">
              <div class="flex items-center grow">
               <img alt="" class="rounded-full size-7 me-2" src="assets/media/avatars/300-29.png"/>
               <a class="text-2sm text-gray-800 hover:text-primary mb-px" href="html/demo10/public-profile/profiles/nft.html">
                Adam Cruse
               </a>
              </div>
	...
	.dark .offer-bg {
		background-image: url('assets/media/images/2600x1200/bg-4-dark.png');
           ...
           <a class="card border-2 border-dashed border-brand-clarity bg-center bg-[length:750px] bg-no-repeat offer-bg" href="#">
         ...
         <div class="hidden" id="works_list">
          <div class="flex flex-col gap-5 lg:gap-7.5">
           <div class="card p-5">
            <div class="flex flex-wrap justify-between items-center gap-7">
             <div class="flex flex-wrap items-center gap-5">
              <img alt="" class="rounded-md max-h-20 max-w-full shrink-0" src="assets/media/images/600x400/21.jpg"/>
             ...
             <div class="flex flex-wrap items-center gap-5 lg:gap-7.5">
              <div class="flex items-center gap-1.5">
               <img alt="" class="rounded-full h-7" src="assets/media/avatars/300-6.png"/>
               <a class="text-2sm font-medium text-gray-700 hover:text-primary-active mb-px" href="#">
                Cody Fisher
               </a>
              </div>
           ...
           <div class="card p-5">
            <div class="flex flex-wrap justify-between items-center gap-7">
             <div class="flex flex-wrap items-center gap-5">
              <img alt="" class="rounded-md max-h-20 max-w-full shrink-0" src="assets/media/images/600x400/3.jpg"/>
              <div class="grid grid-col gap-1">
               <a class="text-lg font-semibold text-gray-900 hover:text-primary-active mb-px" href="#">
                Whispered Emotions
               </a>
             ...
             <div class="flex flex-wrap items-center gap-5 lg:gap-7.5">
              <div class="flex items-center gap-1.5">
               <img alt="" class="rounded-full h-7" src="assets/media/avatars/300-14.png"/>
               <a class="text-2sm font-medium text-gray-700 hover:text-primary-active mb-px" href="#">
                Wade Warren
               </a>
              </div>
           ...
           <div class="card p-5">
            <div class="flex flex-wrap justify-between items-center gap-7">
             <div class="flex flex-wrap items-center gap-5">
              <img alt="" class="rounded-md max-h-20 max-w-full shrink-0" src="assets/media/images/600x400/22.jpg"/>
              <div class="grid grid-col gap-1">
               <a class="text-lg font-semibold text-gray-900 hover:text-primary-active mb-px" href="#">
                Golden Serenity
               </a>
             ...
             <div class="flex flex-wrap items-center gap-5 lg:gap-7.5">
              <div class="flex items-center gap-1.5">
               <img alt="" class="rounded-full h-7" src="assets/media/avatars/300-11.png"/>
               <a class="text-2sm font-medium text-gray-700 hover:text-primary-active mb-px" href="#">
                Albert Flores
               </a>
              </div>
           ...
           <div class="card p-5">
            <div class="flex flex-wrap justify-between items-center gap-7">
             <div class="flex flex-wrap items-center gap-5">
              <img alt="" class="rounded-md max-h-20 max-w-full shrink-0" src="assets/media/images/600x400/23.jpg"/>
              <div class="grid grid-col gap-1">
               <a class="text-lg font-semibold text-gray-900 hover:text-primary-active mb-px" href="#">
                Mystic Shadows
               </a>
             ...
             <div class="flex flex-wrap items-center gap-5 lg:gap-7.5">
              <div class="flex items-center gap-1.5">
               <img alt="" class="rounded-full h-7" src="assets/media/avatars/300-1.png"/>
               <a class="text-2sm font-medium text-gray-700 hover:text-primary-active mb-px" href="#">
                Kathryn Murphy
               </a>
              </div>
           ...
           <div class="card p-5">
            <div class="flex flex-wrap justify-between items-center gap-7">
             <div class="flex flex-wrap items-center gap-5">
              <img alt="" class="rounded-md max-h-20 max-w-full shrink-0" src="assets/media/images/600x400/14.jpg"/>
              <div class="grid grid-col gap-1">
               <a class="text-lg font-semibold text-gray-900 hover:text-primary-active mb-px" href="#">
                Wild Beauty
               </a>
             ...
             <div class="flex flex-wrap items-center gap-5 lg:gap-7.5">
              <div class="flex items-center gap-1.5">
               <img alt="" class="rounded-full h-7" src="assets/media/avatars/300-16.png"/>
               <a class="text-2sm font-medium text-gray-700 hover:text-primary-active mb-px" href="#">
                Devon Lane
               </a>
              </div>
           ...
           <div class="card p-5">
            <div class="flex flex-wrap justify-between items-center gap-7">
             <div class="flex flex-wrap items-center gap-5">
              <img alt="" class="rounded-md max-h-20 max-w-full shrink-0" src="assets/media/images/600x400/25.jpg"/>
              <div class="grid grid-col gap-1">
               <a class="text-lg font-semibold text-gray-900 hover:text-primary-active mb-px" href="#">
                Timeless Elegance
               </a>
             ...
             <div class="flex flex-wrap items-center gap-5 lg:gap-7.5">
              <div class="flex items-center gap-1.5">
               <img alt="" class="rounded-full h-7" src="assets/media/avatars/300-5.png"/>
               <a class="text-2sm font-medium text-gray-700 hover:text-primary-active mb-px" href="#">
                Jenny Wilson
               </a>
              </div>
           ...
           <div class="card p-5">
            <div class="flex flex-wrap justify-between items-center gap-7">
             <div class="flex flex-wrap items-center gap-5">
              <img alt="" class="rounded-md max-h-20 max-w-full shrink-0" src="assets/media/images/600x400/26.jpg"/>
              <div class="grid grid-col gap-1">
               <a class="text-lg font-semibold text-gray-900 hover:text-primary-active mb-px" href="#">
                Intrepid Travel
               </a>
             ...
             <div class="flex flex-wrap items-center gap-5 lg:gap-7.5">
              <div class="flex items-center gap-1.5">
               <img alt="" class="rounded-full h-7" src="assets/media/avatars/300-25.png"/>
               <a class="text-2sm font-medium text-gray-700 hover:text-primary-active mb-px" href="#">
                Jhon Smith
               </a>
              </div>
           ...
           <div class="card p-5">
            <div class="flex flex-wrap justify-between items-center gap-7">
             <div class="flex flex-wrap items-center gap-5">
              <img alt="" class="rounded-md max-h-20 max-w-full shrink-0" src="assets/media/images/600x400/2.jpg"/>
              <div class="grid grid-col gap-1">
               <a class="text-lg font-semibold text-gray-900 hover:text-primary-active mb-px" href="#">
                We rise together
               </a>
             ...
             <div class="flex flex-wrap items-center gap-5 lg:gap-7.5">
              <div class="flex items-center gap-1.5">
               <img alt="" class="rounded-full h-7" src="assets/media/avatars/300-29.png"/>
               <a class="text-2sm font-medium text-gray-700 hover:text-primary-active mb-px" href="#">
                Adam Cruse
               </a>
              </div>
	...
	.dark .offer-bg {
		background-image: url('assets/media/images/2600x1200/bg-4-dark.png');
           ...
           <a class="card border-2 border-dashed border-brand-clarity bg-center bg-[length:600px] bg-no-repeat offer-bg" href="#">
            <div class="card-body">
