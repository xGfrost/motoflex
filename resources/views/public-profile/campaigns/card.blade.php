...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Campaigns - Card
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/campaigns/card" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Campaigns in card layout, using Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Campaigns - Card" name="twitter:title"/>
  <meta content="Campaigns in card layout, using Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/campaigns/card" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Campaigns - Card" property="og:title"/>
  <meta content="Campaigns in card layout, using Tailwind CSS" property="og:description"/>
        ...
        <div class="flex flex-col items-stretch gap-5 lg:gap-7.5">
         ...
         <div class="flex flex-wrap items-center gap-5 justify-between">
          ...
          <div class="flex gap-5">
           <div class="btn-tabs" data-tabs="true">
            <a class="btn btn-icon active" data-tab-toggle="#campaigns_cards" href="#">
             <i class="ki-filled ki-category">
             </i>
            </a>
            <a class="btn btn-icon" data-tab-toggle="#campaigns_list" href="#">
         ...
         <div class="" id="campaigns_cards">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-7.5">
           <div class="card overflow-hidden grow justify-between">
            <div class="p-5 mb-5">
             ...
             <div class="flex items-center justify-center h-[50px] mb-2">
              <img alt="" class="size-[50px] shrink-0" src="assets/media/brand-logos/twitch-purple.svg"/>
             </div>
           ...
           <div class="card overflow-hidden grow justify-between">
            <div class="p-5 mb-5">
             ...
             <div class="flex items-center justify-center h-[50px] mb-2">
              <img alt="" class="size-[50px] shrink-0" src="assets/media/brand-logos/instagram.svg"/>
             </div>
             <div class="text-center mb-7">
              <a class="text-lg font-medium text-gray-900 hover:text-primary" href="">
               Photo Promotion
              ...
              <div class="text-sm text-gray-700">
               Visual Stories Unleashed Worldwide
              </div>
             </div>
             <div class="flex items-center justify-center flex-wrap gap-2 lg:gap-5">
              <div class="flex flex-col gap-1.5 border border-dashed border-gray-300 rounded-md px-2.5 py-2">
           ...
           <div class="card overflow-hidden grow justify-between">
            <div class="p-5 mb-5">
             ...
             <div class="flex items-center justify-center h-[50px] mb-2">
              <img alt="" class="size-[50px] shrink-0" src="assets/media/brand-logos/youtube.svg"/>
             </div>
             <div class="text-center mb-7">
              <a class="text-lg font-medium text-gray-900 hover:text-primary" href="">
               Video Viral
              ...
              <div class="text-sm text-gray-700">
               Video Content Showcase Spotlighted
              </div>
             </div>
             <div class="flex items-center justify-center flex-wrap gap-2 lg:gap-5">
              <div class="flex flex-col gap-1.5 border border-dashed border-gray-300 rounded-md px-2.5 py-2">
           ...
           <div class="card overflow-hidden grow justify-between">
            <div class="p-5 mb-5">
             ...
             <div class="flex items-center justify-center h-[50px] mb-2">
              <img alt="" class="dark:hidden size-[50px] shrink-0" src="assets/media/brand-logos/amazon-2.svg"/>
              <img alt="" class="light:hidden size-[50px] shrink-0" src="assets/media/brand-logos/amazon-dark.svg"/>
             </div>
             <div class="text-center mb-7">
              <a class="text-lg font-medium text-gray-900 hover:text-primary" href="">
               Product Push
              ...
              <div class="text-sm text-gray-700">
               Prime Shopping Bliss Delivered
              </div>
             </div>
             <div class="flex items-center justify-center flex-wrap gap-2 lg:gap-5">
              <div class="flex flex-col gap-1.5 border border-dashed border-gray-300 rounded-md px-2.5 py-2">
           ...
           <div class="card overflow-hidden grow justify-between">
            <div class="p-5 mb-5">
             ...
             <div class="flex items-center justify-center h-[50px] mb-2">
              <img alt="" class="size-[50px] shrink-0" src="assets/media/brand-logos/mailchimp-1.svg"/>
             </div>
             <div class="text-center mb-7">
              <a class="text-lg font-medium text-gray-900 hover:text-primary" href="">
               Email Engagement
              ...
              <div class="text-sm text-gray-700">
               Email Engagement Power Unleashed
              </div>
             </div>
             <div class="flex items-center justify-center flex-wrap gap-2 lg:gap-5">
              <div class="flex flex-col gap-1.5 border border-dashed border-gray-300 rounded-md px-2.5 py-2">
            ...
            <div class="progress progress-gray-300">
             <div class="progress-bar" style="width: 100%">
             </div>
            </div>
           </div>
           <div class="card overflow-hidden grow justify-between">
            <div class="p-5 mb-5">
             ...
             <div class="flex items-center justify-center h-[50px] mb-2">
              <img alt="" class="size-[50px] shrink-0" src="assets/media/brand-logos/linkedin.svg"/>
             </div>
             <div class="text-center mb-7">
              <a class="text-lg font-medium text-gray-900 hover:text-primary" href="">
               Career Boost
              ...
              <div class="text-sm text-gray-700">
               Pro Connections Empowered Globally
              </div>
             </div>
             <div class="flex items-center justify-center flex-wrap gap-2 lg:gap-5">
              <div class="flex flex-col gap-1.5 border border-dashed border-gray-300 rounded-md px-2.5 py-2">
          ...
          <div class="flex grow justify-center pt-5 lg:pt-7.5">
           <a class="btn btn-link" href="html/demo10/account/integrations.html">
            Show more Campaigns
           </a>
          </div>
         </div>
         <!-- end: cards -->
         <!-- begin: list -->
         <div class="hidden" id="campaigns_list">
