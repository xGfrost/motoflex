...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS 2 Columns
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/projects/2-columns" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="2 Columns project layout, powered by Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS 2 Columns" name="twitter:title"/>
  <meta content="2 Columns project layout, powered by Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/projects/2-columns" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS 2 Columns" property="og:title"/>
  <meta content="2 Columns project layout, powered by Tailwind CSS" property="og:description"/>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-7.5">
           <div class="card overflow-hidden grow justify-between">
            <div class="p-5 mb-5">
             ...
             <div class="flex justify-center mb-2">
              <img alt="" class="min-w-12 shrink-0" src="assets/media/brand-logos/office.svg"/>
             </div>
             ...
             <div class="flex items-center justify-center flex-wrap gap-2 lg:gap-5">
              <div class="grid grid-cols-1 content-between gap-1.5 border border-dashed border-gray-300 shrink-0 rounded-md px-2.5 py-2 min-w-24 max-w-auto">
           ...
           <div class="card overflow-hidden grow justify-between">
            <div class="p-5 mb-5">
             ...
             <div class="flex justify-center mb-2">
              <img alt="" class="min-w-12 shrink-0" src="assets/media/brand-logos/btcchina.svg"/>
             </div>
             <div class="text-center mb-7">
              <a class="text-lg font-medium text-gray-900 hover:text-primary" href="">
             ...
             <div class="grid justify-center gap-1.5 mb-7.5">
              ...
              <div class="flex -space-x-2">
               ...
               <div class="flex">
                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-7" src="assets/media/avatars/300-17.png"/>
               </div>
               <div class="flex">
                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-7" src="assets/media/avatars/300-16.png"/>
               </div>
              </div>
             </div>
             <div class="flex items-center justify-center flex-wrap gap-2 lg:gap-5">
           ...
           <div class="card overflow-hidden grow justify-between">
            <div class="p-5 mb-5">
             ...
             <div class="flex justify-center mb-2">
              <img alt="" class="min-w-12 shrink-0" src="assets/media/brand-logos/jira.svg"/>
             </div>
             <div class="text-center mb-7">
              <a class="text-lg font-medium text-gray-900 hover:text-primary" href="">
               SparkleTech
             ...
             <div class="grid justify-center gap-1.5 mb-7.5">
              ...
              <div class="flex -space-x-2">
               ...
               <div class="flex">
                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-7" src="assets/media/avatars/300-9.png"/>
               </div>
              </div>
             </div>
             <div class="flex items-center justify-center flex-wrap gap-2 lg:gap-5">
           ...
           <div class="card overflow-hidden grow justify-between">
            <div class="p-5 mb-5">
             ...
             <div class="flex justify-center mb-2">
              <img alt="" class="min-w-12 shrink-0" src="assets/media/brand-logos/equacoin.svg"/>
             </div>
             <div class="text-center mb-7">
              <a class="text-lg font-medium text-gray-900 hover:text-primary" href="">
               Nexus Design System
             ...
             <div class="grid justify-center gap-1.5 mb-7.5">
              ...
              <div class="flex -space-x-2">
               ...
               <div class="flex">
                <span class="hover:z-5 relative inline-flex items-center justify-center shrink-0 rounded-full ring-1 font-semibold leading-none text-3xs size-7 text-warning-inverse ring-warning-light bg-warning">
                 W
                </span>
               </div>
              </div>
           ...
           <div class="card overflow-hidden grow justify-between">
            <div class="p-5 mb-5">
             ...
             <div class="flex justify-center mb-2">
              <img alt="" class="min-w-12 shrink-0" src="assets/media/brand-logos/slack.svg"/>
             </div>
             <div class="text-center mb-7">
              <a class="text-lg font-medium text-gray-900 hover:text-primary" href="">
               Neptune App
             ...
             <div class="grid justify-center gap-1.5 mb-7.5">
              ...
              <div class="flex -space-x-2">
               ...
               <div class="flex">
                <span class="hover:z-5 relative inline-flex items-center justify-center shrink-0 rounded-full ring-1 font-semibold leading-none text-3xs size-7 text-info-inverse ring-info-light bg-info">
                 P
                </span>
               </div>
              </div>
           ...
           <div class="card overflow-hidden grow justify-between">
            <div class="p-5 mb-5">
             ...
             <div class="flex justify-center mb-2">
              <img alt="" class="min-w-12 shrink-0" src="assets/media/brand-logos/grab.svg"/>
             </div>
             <div class="text-center mb-7">
              <a class="text-lg font-medium text-gray-900 hover:text-primary" href="">
               Radiant Wave
             ...
             <div class="grid justify-center gap-1.5 mb-7.5">
              ...
              <div class="flex -space-x-2">
               <div class="flex">
                <img class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-light-light size-7" src="assets/media/avatars/300-24.png"/>
               </div>
               <div class="flex">
