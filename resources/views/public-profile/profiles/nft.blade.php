...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS NFT
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/profiles/nft" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="NFT public profile layout styled with Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS NFT" name="twitter:title"/>
  <meta content="NFT public profile layout styled with Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/profiles/nft" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS NFT" property="og:title"/>
  <meta content="NFT public profile layout styled with Tailwind CSS" property="og:description"/>
             ...
             <div class="grid gap-y-5">
              <div class="flex align-start gap-2">
               ...
               <div class="flex flex-col gap-2">
                <span class="text-2.5xl font-semibold text-gray-900 leading-none tracking-tight">
                 302.97 XMR
                </span>
           ...
           <div class="card">
            ...
            <div class="card-body">
             <div class="flex flex-col gap-3.5 mb-3.5">
              <div class="flex items-center gap-2.5">
               <span class="text-sm text-gray-600 min-w-14 xl:min-w-24 shrink-0">
                Joined:
               </span>
             ...
             <p class="text-sm text-gray-800 leading-5.5 mb-2.5">
              Experienced and creative professional with a 
			passion great as a commitment to best excellence.
             </p>
            </div>
           </div>
           <div class="card">
           ...
           <div class="card">
            ...
            <div class="card-body">
             <div class="grid gap-y-3.5">
              <div class="flex items-center gap-2.5">
               <i class="ki-filled ki-dribbble text-base text-gray-500">
               </i>
              ...
              <div class="flex items-center gap-2.5">
               <i class="ki-filled ki-twitter text-base text-gray-500">
               </i>
               <a class="text-sm leading-none text-gray-900 hover:text-primary-active" href="#">
                jennynft
               </a>
           ...
           <div class="flex flex-col gap-5 lg:gap-7.5">
            <div class="card">
             <div class="card-header">
              ...
              <a class="btn btn-link" href="html/demo10/network/user-cards/author.html">
               View All
              </a>
             </div>
             <div class="card-body p-5 lg:p-7.5 lg:pb-7">
              <div class="flex gap-5 scrollable-x">
               <div class="card shadow-none border-0 mb-5">
                <div class="rounded-t-xl w-[280px] h-[240px] bg-cover bg-center" style="background-image: url('assets/media/images/600x600/1.jpg')">
                </div>
                <div class="card-border card-rounded-b px-3.5 pt-5 pb-3.5">
                 ...
                 <div class="grid grid-cols-2 items-center">
                  ...
                  <div class="flex flex-col justify-self-end text-end gap-2">
                   <span class="text-2sm text-gray-700">
                    Ending in
                   </span>
               ...
               <div class="card shadow-none border-0 mb-5">
                <div class="rounded-t-xl w-[280px] h-[240px] bg-cover bg-center" style="background-image: url('assets/media/images/600x600/2.jpg')">
                </div>
                <div class="card-border card-rounded-b px-3.5 pt-5 pb-3.5">
                 <div class="pb-6">
                  <a class="font-media/images/600x600/ block font-medium text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
               ...
               <div class="card shadow-none border-0 mb-5">
                <div class="rounded-t-xl w-[280px] h-[240px] bg-cover bg-center" style="background-image: url('assets/media/images/600x600/3.jpg')">
                </div>
                <div class="card-border card-rounded-b px-3.5 pt-5 pb-3.5">
                 <div class="pb-6">
                  <a class="font-media/images/600x600/ block font-medium text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
               ...
               <div class="card shadow-none border-0 mb-5">
                <div class="rounded-t-xl w-[280px] h-[240px] bg-cover bg-center" style="background-image: url('assets/media/images/600x600/4.jpg')">
                </div>
                <div class="card-border card-rounded-b px-3.5 pt-5 pb-3.5">
                 <div class="pb-6">
                  <a class="font-media/images/600x600/ block font-medium text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
               ...
               <div class="card shadow-none border-0 mb-5">
                <div class="rounded-t-xl w-[280px] h-[240px] bg-cover bg-center" style="background-image: url('assets/media/images/600x600/5.jpg')">
                </div>
                <div class="card-border card-rounded-b px-3.5 pt-5 pb-3.5">
                 <div class="pb-6">
                  <a class="font-media/images/600x600/ block font-medium text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
            ...
            <div class="card">
             ...
             <div class="card-body p-5 lg:p-7.5 lg:pb-7">
              <div class="flex gap-5 scrollable-x">
               ...
               <div class="card shadow-none border-0 mb-5">
                <div class="rounded-t-xl w-[280px] h-[240px] bg-cover bg-center" style="background-image: url('assets/media/images/600x600/6.jpg')">
                </div>
                <div class="card-border card-rounded-b px-3.5 pt-5 pb-3.5">
                 <div class="pb-6">
                  <a class="font-media/images/600x600/ block font-medium text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
               ...
               <div class="card shadow-none border-0 mb-5">
                <div class="rounded-t-xl w-[280px] h-[240px] bg-cover bg-center" style="background-image: url('assets/media/images/600x600/7.jpg')">
                </div>
                <div class="card-border card-rounded-b px-3.5 pt-5 pb-3.5">
                 <div class="pb-6">
                  <a class="font-media/images/600x600/ block font-medium text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
               ...
               <div class="card shadow-none border-0 mb-5">
                <div class="rounded-t-xl w-[280px] h-[240px] bg-cover bg-center" style="background-image: url('assets/media/images/600x600/8.jpg')">
                </div>
                <div class="card-border card-rounded-b px-3.5 pt-5 pb-3.5">
                 <div class="pb-6">
                  <a class="font-media/images/600x600/ block font-medium text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
            ...
            <div class="card">
             ...
             <div class="card-body p-5 lg:p-7.5 lg:pb-7">
              <div class="flex gap-5 scrollable-x">
               ...
               <div class="card shadow-none border-0 mb-5">
                <div class="rounded-t-xl w-[280px] h-[240px] bg-cover bg-center" style="background-image: url('assets/media/images/600x600/10.jpg')">
                </div>
                <div class="card-border card-rounded-b px-3.5 pt-5 pb-3.5">
                 <div class="pb-6">
                  <a class="font-media/images/600x600/ block font-medium text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
               ...
               <div class="card shadow-none border-0 mb-5">
                <div class="rounded-t-xl w-[280px] h-[240px] bg-cover bg-center" style="background-image: url('assets/media/images/600x600/11.jpg')">
                </div>
                <div class="card-border card-rounded-b px-3.5 pt-5 pb-3.5">
                 <div class="pb-6">
                  <a class="font-media/images/600x600/ block font-medium text-gray-900 hover:text-primary text-md leading-4 mb-2" href="#">
