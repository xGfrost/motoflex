...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Blogger
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/profiles/blogger" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Blogger public profile layout, powered by Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Blogger" name="twitter:title"/>
  <meta content="Blogger public profile layout, powered by Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/profiles/blogger" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Blogger" property="og:title"/>
  <meta content="Blogger public profile layout, powered by Tailwind CSS" property="og:description"/>
         ...
         <div class="flex flex-col items-center gap-2 lg:gap-3.5 py-4 lg:pt-5 lg:pb-10">
          ...
          <div class="flex flex-wrap justify-center gap-1 lg:gap-4.5 text-sm">
           <div class="flex gap-1.25 items-center">
            <i class="ki-filled ki-dribbble text-gray-500 text-sm">
            </i>
          ...
          <div class="flex flex-col gap-5 lg:gap-7.5">
           <div class="card">
            <div class="card-body px-10 py-7.5 lg:pe-12.5">
             <div class="flex flex-wrap md:flex-nowrap items-center gap-6 md:gap-10">
              ...
              <img alt="image" class="dark:hidden max-h-[160px]" src="assets/media/illustrations/1.svg"/>
           ...
           <div class="card">
            <div class="card-header">
             ...
             <a class="btn btn-link" href="html/demo10/public-profile/profiles/feeds.html">
              View All
             </a>
            </div>
            <div class="card-body p-5 lg:p-7.5 lg:pb-7">
             <div class="flex flex-no-wrap scrollable-x gap-5">
              <div class="card shadow-none w-[280px] border-0 mb-4">
               <div class="rounded-t-xl w-[280px] h-[240px] bg-cover bg-center" style="background-image: url('assets/media/images/600x400/14.jpg')">
               </div>
               <div class="card-border card-rounded-b grid gap-1.5 px-5 py-4">
                <a class="font-medium text-brand text-2sm hover:text-primary" href="#">
                 Software
                </a>
                <a class="font-medium text-gray-900 text-lg leading-6 mb-1.5 hover:text-primary" href="#">
                 Maximizing Efficiency with Modern Software
                </a>
                <time class="flex items-center gap-1.5 text-2sm text-gray-700 leading-none">
                 <i class="ki-filled ki-time text-lg text-gray-500">
                 </i>
                 4 hours ago
                </time>
               </div>
              ...
              <div class="card shadow-none w-[280px] border-0 mb-4">
               <div class="rounded-t-xl w-[280px] h-[240px] bg-cover bg-center" style="background-image: url('assets/media/images/600x400/15.jpg')">
               </div>
               <div class="card-border card-rounded-b grid gap-1.5 px-5 py-4">
                <a class="font-medium text-brand text-2sm hover:text-primary" href="#">
                 Work-Life
              ...
              <div class="card shadow-none w-[280px] border-0 mb-4">
               <div class="rounded-t-xl w-[280px] h-[240px] bg-cover bg-center" style="background-image: url('assets/media/images/600x400/16.jpg')">
               </div>
               <div class="card-border card-rounded-b grid gap-1.5 px-5 py-4">
                <a class="font-medium text-brand text-2sm hover:text-primary" href="#">
                 Technology
              ...
              <div class="card shadow-none w-[280px] border-0 mb-4">
               <div class="rounded-t-xl w-[280px] h-[240px] bg-cover bg-center" style="background-image: url('assets/media/images/600x400/11.jpg')">
               </div>
               <div class="card-border card-rounded-b grid gap-1.5 px-5 py-4">
                <a class="font-medium text-brand text-2sm hover:text-primary" href="#">
                </a>
              ...
              <div class="card shadow-none w-[280px] border-0 mb-4">
               <div class="rounded-t-xl w-[280px] h-[240px] bg-cover bg-center" style="background-image: url('assets/media/images/600x400/12.jpg')">
               </div>
               <div class="card-border card-rounded-b grid gap-1.5 px-5 py-4">
                <a class="font-medium text-brand text-2sm hover:text-primary" href="#">
                </a>
           ...
           <div class="card">
            ...
            <div class="card-body pb-7">
             <div class="flex flex-col gap-5">
              <div class="border-l-2 border-brand">
               <div class="flex gap-3 items-center ps-3 mb-0.5">
                <span class="text-2xs text-gray-600">
                 10 Jan, 24
                </span>
                <div class="rounded-full w-1.5 h-1.5 bg-gray-300 gap-1.5">
                </div>
               ...
               <p class="text-sm text-gray-800 leading-5.5 ps-3">
                Experienced UI/UX designer seeking new opportunities.
               </p>
              </div>
              ...
              <div class="border-l-2 border-warning">
               <div class="flex gap-3 items-center ps-3 mb-0.5">
                <span class="text-2xs text-gray-600">
                 4 Feb, 24
                </span>
              ...
              <div class="border-l-2 border-success">
               <div class="flex gap-3 items-center ps-3 mb-0.5">
                <span class="text-2xs text-gray-600">
                 17 Mar, 24
                </span>
              ...
              <div class="border-l-2 border-danger">
               <div class="flex gap-3 items-center ps-3 mb-0.5">
                <span class="text-2xs text-gray-600">
                 9 Apr, 24
                </span>
