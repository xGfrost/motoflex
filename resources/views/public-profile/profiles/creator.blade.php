...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Creator
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/profiles/creator" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Creator public profile layout with Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Creator" name="twitter:title"/>
  <meta content="Creator public profile layout with Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/profiles/creator" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Creator" property="og:title"/>
  <meta content="Creator public profile layout with Tailwind CSS" property="og:description"/>
       ...
       <div class="bg-center bg-cover bg-no-repeat hero-bg">
        ...
        <div class="container-fixed">
         <div class="flex flex-col items-center gap-2 lg:gap-3.5 py-4 lg:pt-5 lg:pb-10">
          <div class="flex items-center justify-center rounded-full border-2 border-danger-clarity bg-light size-[100px] shrink-0">
           <img class="size-11" src="assets/media/brand-logos/inferno.svg"/>
          </div>
          <div class="flex items-center gap-1.5">
          ...
          <div class="flex flex-wrap justify-center gap-1 lg:gap-4.5 text-sm">
           <div class="flex gap-1.25 items-center">
            <i class="ki-filled ki-icon text-gray-500 text-sm">
            </i>
           ...
           <div class="menu gap-3" data-menu="true">
            <div class="menu-item border-b-2 border-b-transparent menu-item-active:border-b-primary menu-item-here:border-b-primary here" data-menu-item-overflow="true" data-menu-item-placement="bottom-start" data-menu-item-placement-rtl="bottom-end" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
             ...
             <div class="menu-dropdown menu-default py-2 min-w-[200px]">
              ...
              <div class="menu-item" data-menu-item-offset="-10px, 0" data-menu-item-placement="right-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
           ...
           <div class="card">
            ...
            <div class="card-body">
             <div class="flex flex-wrap gap-2.5 xl:me-16">
              ...
              <img class="rounded-full h-[36px]" src="assets/media/avatars/300-7.png"/>
          ...
          <div class="flex flex-col gap-5 lg:gap-7.5">
           <div class="card">
            <div class="card-body px-10 py-7.5 lg:pe-12.5">
             <div class="flex flex-wrap xl:flex-nowrap items-center justify-between gap-6 md:gap-10 p-2.5">
              <div class="flex flex-col items-start gap-3 md:max-w-[60%]">
               <h2 class="text-1.5xl font-semibold text-gray-900">
                Restyle Your Space:
                <br/>
                Soft Goods Makeover Ideas
               </h2>
               <p class="text-sm font-normal text-gray-700 leading-5.5 mb-2.5">
                Transform your living space beautifully with our Restyle Your Space: Soft Goods Makeover Ideas tutorial
               </p>
               <div class="grid md:grid-cols-2 gap-2">
                <div class="flex items-center gap-1.5 pe-7.5">
                 <i class="ki-filled ki-check-circle text-base text-success">
                 </i>
              ...
              <div class="shrink-0">
               <img alt="image" class="dark:hidden max-h-[200px]" src="assets/media/illustrations/18.svg"/>
               <img alt="image" class="light:hidden max-h-[200px]" src="assets/media/illustrations/18-dark.svg"/>
              </div>
             </div>
            </div>
            <div class="card-footer justify-center">
             <a class="btn btn-link" href="html/demo10/network/get-started.html">
              Get Started
             </a>
            </div>
           </div>
           <div class="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-7.5">
            <div class="card border-0">
             <img alt="" class="w-full h-auto rounded-t-xl" src="assets/media/images/600x400/1.jpg"/>
             <div class="card-border card-rounded-b flex flex-col gap-2 px-5 py-4.5">
              <a class="text-lg font-medium text-gray-900 hover:text-primary" href="html/demo10/public-profile/profiles/company.html">
               Urban Dreams
              </a>
              <div class="flex items-center justify-between grow">
               <div class="flex items-center grow">
                <img alt="" class="rounded-full size-7 me-2" src="assets/media/avatars/300-6.png"/>
                <a class="text-2sm text-gray-800 hover:text-primary mb-px" href="html/demo10/public-profile/profiles/nft.html">
                 Cody Fisher
                </a>
               </div>
               <div class="flex gap-3 items-center">
                <div class="flex gap-1 items-center">
                 ...
                 <span class="text-2sm text-gray-800 py-2">
                  24
                 </span>
                </div>
                <div class="flex gap-1 items-center">
            ...
            <div class="card border-0">
             <img alt="" class="w-full h-auto rounded-t-xl" src="assets/media/images/600x400/2.jpg"/>
             <div class="card-border card-rounded-b flex flex-col gap-2 px-5 py-4.5">
              <a class="text-lg font-medium text-gray-900 hover:text-primary" href="html/demo10/public-profile/profiles/company.html">
               Timeless Elegance
              </a>
              <div class="flex items-center justify-between grow">
               <div class="flex items-center grow">
                <img alt="" class="rounded-full size-7 me-2" src="assets/media/avatars/300-5.png"/>
                <a class="text-2sm text-gray-800 hover:text-primary mb-px" href="html/demo10/public-profile/profiles/nft.html">
                 Jenny Wilson
                </a>
               </div>
            ...
            <div class="card border-0">
             <img alt="" class="w-full h-auto rounded-t-xl" src="assets/media/images/600x400/3.jpg"/>
             <div class="card-border card-rounded-b flex flex-col gap-2 px-5 py-4.5">
              <a class="text-lg font-medium text-gray-900 hover:text-primary" href="html/demo10/public-profile/profiles/company.html">
               Whispered Emotions
              </a>
              <div class="flex items-center justify-between grow">
               <div class="flex items-center grow">
                <img alt="" class="rounded-full size-7 me-2" src="assets/media/avatars/300-14.png"/>
                <a class="text-2sm text-gray-800 hover:text-primary mb-px" href="html/demo10/public-profile/profiles/nft.html">
                 Wade Warren
                </a>
               </div>
            ...
            <div class="card border-0">
             <img alt="" class="w-full h-auto rounded-t-xl" src="assets/media/images/600x400/4.jpg"/>
             <div class="card-border card-rounded-b flex flex-col gap-2 px-5 py-4.5">
              <a class="text-lg font-medium text-gray-900 hover:text-primary" href="html/demo10/public-profile/profiles/company.html">
               Golden Serenity
              </a>
              <div class="flex items-center justify-between grow">
               <div class="flex items-center grow">
                <img alt="" class="rounded-full size-7 me-2" src="assets/media/avatars/300-11.png"/>
                <a class="text-2sm text-gray-800 hover:text-primary mb-px" href="html/demo10/public-profile/profiles/nft.html">
                 Albert Flores
                </a>
               </div>
            ...
            <div class="card border-0">
             <img alt="" class="w-full h-auto rounded-t-xl" src="assets/media/images/600x400/5.jpg"/>
             <div class="card-border card-rounded-b flex flex-col gap-2 px-5 py-4.5">
              <a class="text-lg font-medium text-gray-900 hover:text-primary" href="html/demo10/public-profile/profiles/company.html">
               Wild Beauty
              </a>
              <div class="flex items-center justify-between grow">
               <div class="flex items-center grow">
                <img alt="" class="rounded-full size-7 me-2" src="assets/media/avatars/300-16.png"/>
                <a class="text-2sm text-gray-800 hover:text-primary mb-px" href="html/demo10/public-profile/profiles/nft.html">
                 Devon Lane
                </a>
               </div>
            ...
            <div class="card border-0">
             <img alt="" class="w-full h-auto rounded-t-xl" src="assets/media/images/600x400/6.jpg"/>
             <div class="card-border card-rounded-b flex flex-col gap-2 px-5 py-4.5">
              <a class="text-lg font-medium text-gray-900 hover:text-primary" href="html/demo10/public-profile/profiles/company.html">
               Mystic Shadows
              </a>
              <div class="flex items-center justify-between grow">
               <div class="flex items-center grow">
                <img alt="" class="rounded-full size-7 me-2" src="assets/media/avatars/300-1.png"/>
                <a class="text-2sm text-gray-800 hover:text-primary mb-px" href="html/demo10/public-profile/profiles/nft.html">
                 Kathryn Murphy
                </a>
               </div>
           ...
           <div class="card">
            ...
            <div class="card-body lg:pt-7 pt-5 pb-2">
             <div class="grid gap-3.5">
              <div class="flex flex-col md:flex-row md:items-center gap-5">
               <div class="flex items-center gap-5 shrink-0">
                ...
                <img alt="" class="rounded-lg max-h-[120px] max-w-full" src="assets/media/images/600x400/7.jpg">
                </img>
               </div>
               <div class="flex flex-col gap-2">
                <a class="text-2sm font-medium text-brand leading-[14px] hover:text-primary-active mb-px" href="#">
                 Webinar Series
                </a>
                <a class="text-base font-medium hover:text-primary text-gray-900 leading-4" href="#">
                 Digital Marketing Mastery Series
                </a>
                <p class="text-sm text-gray-800 leading-[22px]">
                 Join our comprehensive webinars to master
				the art of digital marketing strategies.
                </p>
               </div>
              </div>
              <div class="[&:not(:last-child)]:border-b border-b-gray-200">
              </div>
              <div class="flex flex-col md:flex-row md:items-center gap-5">
               <div class="flex items-center gap-5 shrink-0">
                <div class="border border-brand-clarity rounded-lg">
                ...
                <img alt="" class="rounded-lg max-h-[120px] max-w-full" src="assets/media/images/600x400/8.jpg">
                </img>
               </div>
               <div class="flex flex-col gap-2">
                <a class="text-2sm font-medium text-brand leading-[14px] hover:text-primary-active mb-px" href="#">
				...
				hands-on workshop guided by experienced photographers.
                </p>
               </div>
              </div>
              <div class="[&:not(:last-child)]:border-b border-b-gray-200">
              ...
              <div class="flex flex-col md:flex-row md:items-center gap-5">
               <div class="flex items-center gap-5 shrink-0">
                ...
                <img alt="" class="rounded-lg max-h-[120px] max-w-full" src="assets/media/images/600x400/9.jpg">
                </img>
               </div>
               <div class="flex flex-col gap-2">
                <a class="text-2sm font-medium text-brand leading-[14px] hover:text-primary-active mb-px" href="#">
                ...
                <p class="text-sm text-gray-800 leading-[22px]">
                 Delve into tech innovations and emerging trends at this 
				influential conference for tech enthusiasts.
                </p>
               </div>
              </div>
              <div class="[&:not(:last-child)]:border-b border-b-gray-200">
               ...
               <div class="ps-2.5 mb-7 text-md grow">
                <div class="flex flex-col">
                 <div class="text-sm text-gray-800">
                  Posted a new article
                  <a class="text-sm font-medium link" href="html/demo10/public-profile/profiles/blogger.html">
                   Top 10 Tech Trends
                  </a>
                 </div>
               ...
               <div class="ps-2.5 mb-7 text-md grow">
                <div class="flex flex-col">
                 <div class="text-sm text-gray-800">
                  ...
                  <a class="text-sm link" href="html/demo10/public-profile/profiles/blogger.html">
                   upcoming blog post
                  </a>
                 </div>
                 <span class="text-xs text-gray-600">
               ...
               <div class="ps-2.5 mb-7 text-md grow">
                <div class="flex flex-col">
                 <div class="text-sm text-gray-900">
                  ...
                  <a class="text-sm font-medium link" href="html/demo10/public-profile/profiles/feeds.html">
                   10,000 followers
                  </a>
              ...
              <div class="flex items-start relative">
               ...
               <div class="ps-2.5 text-md grow">
                <div class="flex flex-col">
                 <div class="text-sm text-gray-800">
                  We recently
                  <a class="text-sm font-medium link" href="html/demo10/public-profile/profiles/nft.html">
                   celebrated
                  </a>
