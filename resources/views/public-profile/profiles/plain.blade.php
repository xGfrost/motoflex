...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Plain
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/profiles/plain" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Plain public profile layout, styled with Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Plain" name="twitter:title"/>
  <meta content="Plain public profile layout, styled with Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/profiles/plain" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Plain" property="og:title"/>
  <meta content="Plain public profile layout, styled with Tailwind CSS" property="og:description"/>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-7.5">
          ...
          <div class="card">
           <div class="card-body lg:py-9">
            <div class="flex justify-center pb-5">
             <img alt="" class="dark:hidden max-h-[170px]" src="assets/media/illustrations/11.svg"/>
             <img alt="" class="light:hidden max-h-[170px]" src="assets/media/illustrations/11-dark.svg"/>
            </div>
            ...
            <div class="flex items-center justify-center gap-1">
             ...
             <a class="text-sm font-medium link" href="html/demo10/account/billing/plans.html">
              Get Started!
             </a>
            </div>
           </div>
          ...
          <div class="card pb-3 grow">
           ...
           <div class="card-body pt-4">
            <div class="grid gap-2.5 mb-1">
             ...
             <div class="flex items-center gap-2.5">
              <span class="">
               <i class="ki-filled ki-icon text-lg text-gray-500">
               </i>
              </span>
              <a class="text-gray-900 hover:text-primary-active text-sm" href="#">
         ...
         <div class="col-span-1 flex">
          <div class="card grow">
           ...
           <div class="card-body">
			...
			and innovation. With a background in UI/UX design, I have a keen eye for 
			detail and a strong understanding of user experience. My goal is to craft 
			visually appealing and intuitive designs that not only meet clients' 
			...
			techniques, allowing me to bring ideas to life with precision and elegance. 
			I thrive in collaborative environments, where I can work closely 
			with clients and teams to achieve remarkable results.
            </p>
           </div>
          </div>
         </div>
         <div class="col-span-1 flex">
          <div class="card grow">
           ...
           <div class="card-footer justify-center lg:pb-9">
