...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Feeds
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/profiles/feeds" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Feeds layout for public profiles with Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Feeds" name="twitter:title"/>
  <meta content="Feeds layout for public profiles with Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/profiles/feeds" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Feeds" property="og:title"/>
  <meta content="Feeds layout for public profiles with Tailwind CSS" property="og:description"/>
          ...
          <div class="grid gap-5 lg:gap-7.5">
           <div class="card">
            <div class="card-body">
             <div class="flex flex-wrap justify-center gap-2 py-1">
              ...
              <span class="sm:ms-8 sm:ps-8 border-s border-s-gray-200">
              </span>
              <div class="flex flex-col items-center gap-1.5">
               <span class="text-gray-900 text-2x lg:text-2.5xl font-semibold">
                28.9k
               </span>
           ...
           <div class="card">
            ...
            <div class="card-body">
             <p class="text-sm text-gray-800 leading-5.5 mb-4">
              Experienced and creative professional with a passion great 
			as for problem-solving and a commitment to excellence.
             </p>
             <div class="grid gap-y-3.5">
              <div class="flex items-center gap-2.5">
               <i class="ki-filled ki-abstract-41 text-base text-gray-500">
               </i>
               <a class="text-sm leading-none text-gray-900 hover:text-primary-active" href="#">
                KeenThemes
               </a>
              </div>
              <div class="flex items-center gap-2.5">
               <i class="ki-filled ki-crown-2 text-base text-gray-500">
               </i>
               <a class="text-sm leading-none text-gray-900 hover:text-primary-active" href="#">
                Author
               </a>
              ...
              <div class="flex items-center gap-2.5">
               <i class="ki-filled ki-briefcase text-base text-gray-500">
               </i>
               <a class="text-sm leading-none text-gray-900 hover:text-primary-active" href="#">
                UI/UX Desiger
               </a>
              ...
              <div class="flex items-center gap-2.5">
               <i class="ki-filled ki-sms text-base text-gray-500">
               </i>
               <a class="text-sm leading-none text-gray-900 hover:text-primary-active" href="#">
                enny@kteam.com
               </a>
              ...
              <div class="flex items-center gap-2.5">
               <i class="ki-filled ki-abstract-39 text-base text-gray-500">
               </i>
               <a class="text-sm leading-none text-gray-900 hover:text-primary-active" href="#">
              ...
              <div class="flex items-center gap-2.5">
               <i class="ki-filled ki-youtube text-base text-gray-500">
               </i>
               <a class="text-sm leading-none text-gray-900 hover:text-primary-active" href="#">
                keenthemes
               </a>
           ...
           <div class="card">
            ...
            <div class="card-footer justify-center">
             <a class="btn btn-link" href="html/demo10/public-profile/works.html">
              View details
             </a>
            </div>
           </div>
           ...
           <div class="card">
            <div class="flex justify-between items-center mb-5 p-7.5 pb-0">
             <div class="flex items-center gap-3">
              <div class="">
               <img class="rounded-full size-[50px]" src="assets/media/avatars/300-1.png"/>
              </div>
              <div class="flex flex-col">
               <a class="text-md font-medium text-gray-900 hover:text-primary-active mb-1" href="#">
                Jenny Klabber
               </a>
            ...
            <div class="grid gap-5 mb-5 px-7.5">
             <p class="text-sm text-gray-800 leading-5.5">
			...
			that people will actually want to read. Ready? Let’s get started.
             ...
             <div class="grid grid-cols-2 gap-2.5 xl:gap-7.5">
              <div>
               <div class="bg-cover bg-no-repeat min-h-[340px] w-full rounded-xl" style="background-image: url('assets/media/images/600x600/21.jpg')">
               </div>
              </div>
              <div class="grid grid-rows-2 gap-2.5 xl:gap-7.5">
               <div>
                <div class="bg-cover bg-no-repeat rounded-xl h-full w-full" style="background-image: url('assets/media/images/600x400/19.jpg')">
                </div>
               </div>
               <div>
                <div class="bg-cover bg-no-repeat rounded-xl h-full w-full" style="background-image: url('assets/media/images/600x400/20.jpg')">
                </div>
               </div>
              </div>
             </div>
            ...
            <div>
             <div class="flex flex-col sm:flex-row items-stretch sm:items-center flex-wrap gap-2.5 border-gray-300 border-t border-b border-dashed py-3 mb-4 mx-7.5" data-tabs="true">
              <button class="active group btn px-3 text-gray-700 hover:text-primary tab-active:bg-primary-light tab-active:border-primary-clarity tab-active:text-primary" data-tab-toggle="#post_1_comments">
               <i class="ki-filled ki-message-text text-gray-500 group-hover:text-primary tab-active:text-primary">
               </i>
               2 Comments
              </button>
              <button class="group btn px-3 text-gray-700 hover:text-primary tab-active:bg-primary-light tab-active:border-primary-clarity tab-active:text-primary" data-tab-toggle="#post_1_likes">
               <i class="ki-filled ki-heart text-gray-500 group-hover:text-primary tab-active:text-primary">
               </i>
               47k Likes
              </button>
              <button class="group btn px-3 text-gray-700 hover:text-primary tab-active:bg-primary-light tab-active:border-primary-clarity tab-active:text-primary" data-tab-toggle="#post_1_saves">
             ...
             <div id="post_1_comments">
              <div class="grid gap-2 lg:gap-5 p-7.5 pt-0">
               <div class="flex items-start gap-2.5">
                <img alt="" class="rounded-full w-9 h-9 lg:w-[50px] lg:h-[50px] mt-1" src="assets/media/avatars/300-3.png"/>
                <div class="grid gap-2.5 grow">
                 <div class="flex justify-between items-center">
                  <div class="flex items-center gap-1.5">
                   <a class="text-md font-medium text-gray-900 hover:text-primary-active" href="#">
                    Mr. Anderson
                   </a>
                 ...
                 <p class="text-sm text-gray-800 heading-5.5">
			...
			a great blog post in five simple steps that people will actually want to read. Ready?
               ...
               <div class="flex items-start gap-2.5">
                <img alt="" class="rounded-full w-9 h-9 lg:w-[50px] lg:h-[50px] mt-1" src="assets/media/avatars/300-15.png"/>
                <div class="grid gap-2.5 grow">
                 <div class="flex justify-between items-center">
                  <div class="flex items-center gap-1.5">
                   <a class="text-md font-medium text-gray-900 hover:text-primary-active" href="#">
               ...
               <div class="flex items-center gap-2.5">
                <img alt="" class="rounded-full size-10 shrink-0" src="assets/media/avatars/300-3.png"/>
             ...
             <div class="hidden" id="post_1_likes">
              <div class="flex flex-col gap-2 lg:gap-5 pt-3.5 px-7.5 mb-5">
               <div class="flex items-center flex-wrap gap-2">
                <div class="flex items-center grow gap-2.5">
                 <img alt="" class="rounded-full size-10 shrink-0" src="assets/media/avatars/300-14.png"/>
                 <div class="flex flex-col">
                  <a class="text-md font-medium text-gray-900 hover:text-primary-active mb-px" href="#">
                   Adam Wilson
                  </a>
               ...
               <div class="flex items-center flex-wrap gap-2">
                <div class="flex items-center grow gap-2.5">
                 <img alt="" class="rounded-full size-10 shrink-0" src="assets/media/avatars/300-7.png"/>
                 <div class="flex flex-col">
                  <a class="text-md font-medium text-gray-900 hover:text-primary-active mb-px" href="#">
                   Renee Branson
                  </a>
               ...
               <div class="flex items-center flex-wrap gap-2">
                <div class="flex items-center grow gap-2.5">
                 <img alt="" class="rounded-full size-10 shrink-0" src="assets/media/avatars/300-32.png"/>
                 <div class="flex flex-col">
                  <a class="text-md font-medium text-gray-900 hover:text-primary-active mb-px" href="#">
                   Jonathan Taylor
                  </a>
               ...
               <div class="flex items-center flex-wrap gap-2">
                <div class="flex items-center grow gap-2.5">
                 <img alt="" class="rounded-full size-10 shrink-0" src="assets/media/avatars/300-15.png"/>
                 <div class="flex flex-col">
                  <a class="text-md font-medium text-gray-900 hover:text-primary-active mb-px" href="#">
                   Lilia Mattox
                  </a>
               ...
               <div class="flex items-center flex-wrap gap-2">
                <div class="flex items-center grow gap-2.5">
                 <img alt="" class="rounded-full size-10 shrink-0" src="assets/media/avatars/300-25.png"/>
                 <div class="flex flex-col">
                  <a class="text-md font-medium text-gray-900 hover:text-primary-active mb-px" href="#">
                   Neil Roberts
                  </a>
             ...
             <div class="hidden" id="post_1_saves">
              <style>
               .post-saves-bg {
		background-image: url('assets/media/images/2600x1200/bg-2.png');
		margin-top: -1rem;
		height: 7rem;
	}
	.dark .post-saves-bg {
		background-image: url('assets/media/images/2600x1200/bg-2-dark.png');
		height: 12rem;
		margin-bottom: -4.5rem;
              ...
              <div class="text-center p-7.5 pt-5">
               ...
               <span class="text-sm text-gray-600 block mb-7.5">
           ...
           <div class="card">
            ...
            <p class="mb-5 text-sm text-gray-800 leading-5.5 px-7.5">
		...
		cardboard box manufacturing company.” I feel your pain, I really do.
            ...
            <div>
             ...
             <div class="hidden" id="post_2_comments">
              <div class="grid gap-2 lg:gap-5 p-7.5 pt-0">
               <div class="flex items-start gap-2.5">
                <img alt="" class="rounded-full w-9 h-9 lg:w-[50px] lg:h-[50px] mt-1" src="assets/media/avatars/300-1.png"/>
                <div class="grid gap-2.5 grow">
                 <div class="flex justify-between items-center">
                  <div class="flex items-center gap-1.5">
                   <a class="text-md font-medium text-gray-900 hover:text-primary-active" href="#">
	...
	.dark .post-saves-bg {
		...
		margin-bottom: -4.5rem;
           ...
           <div class="card">
            <div class="flex justify-between items-center mb-5 p-7.5 pb-0">
             <div class="flex items-center gap-3">
              <div class="flex items-center justify-center uppercase rounded-full size-[50px] shrink-0 bg-primary-light text-primary">
               <i class="ki-filled ki-tab-tablet text-2xl">
               </i>
              </div>
              <div class="flex flex-col">
               <a class="text-md font-medium text-gray-900 hover:text-primary-active mb-1" href="#">
                Finance Deprt - Annual Report
               </a>
               <time class="text-sm text-gray-600">
                1 week ago
               </time>
            ...
            <p class="text-sm text-gray-800 leading-5.5 px-7.5">
		...
		editorial control over what you write about, then choose topics
		you’d want to read – even if they relate to niche industries.
            </p>
            <div class="p-7.5 pb-5">
             <iframe class="w-full aspect-video rounded-xl min-h-[400px]" src="https://www.youtube.com/embed/2uWJpnuCMKQ?si=6-ohuJieU2Fg3pDr">
             </iframe>
            </div>
            <div>
             <div class="flex flex-col sm:flex-row items-stretch sm:items-center flex-wrap gap-2.5 border-gray-300 border-t border-b border-dashed py-3 mb-4 mx-7.5" data-tabs="true">
              <button class="group btn px-3 text-gray-700 hover:text-primary tab-active:bg-primary-light tab-active:border-primary-clarity tab-active:text-primary" data-tab-toggle="#post_3_comments">
               <i class="ki-filled ki-message-text text-gray-500 group-hover:text-primary tab-active:text-primary">
               </i>
               27 Comments
              </button>
              <button class="active group btn px-3 text-gray-700 hover:text-primary tab-active:bg-primary-light tab-active:border-primary-clarity tab-active:text-primary" data-tab-toggle="#post_3_likes">
               <i class="ki-filled ki-heart text-gray-500 group-hover:text-primary tab-active:text-primary">
               </i>
               47k Likes
              </button>
              <button class="group btn px-3 text-gray-700 hover:text-primary tab-active:bg-primary-light tab-active:border-primary-clarity tab-active:text-primary" data-tab-toggle="#post_3_saves">
               <i class="ki-filled ki-archive-tick text-gray-500 group-hover:text-primary tab-active:text-primary">
               </i>
               900 Saves
              </button>
             </div>
             <div class="hidden" id="post_3_comments">
              <div class="grid gap-2 lg:gap-5 p-7.5 pt-0">
               <div class="flex items-start gap-2.5">
                <img alt="" class="rounded-full w-9 h-9 lg:w-[50px] lg:h-[50px] mt-1" src="assets/media/avatars/300-3.png"/>
                <div class="grid gap-2.5 grow">
			...
			a great blog post in five simple steps that people will actually want to read. Ready?
             ...
             <div class="hidden" id="post_3_saves">
              <style>
               .post-saves-bg {
		background-image: url('assets/media/images/2600x1200/bg-2.png');
		margin-top: -1rem;
	...
	.dark .post-saves-bg {
		...
		margin-bottom: -4.5rem;
           ...
           <div class="card">
            ...
            <p class="text-sm text-gray-800 leading-5.5 mb-5 px-7.5">
             This doesn’t mean that all bloggers are insincere fakers.
		On the contrary, many bloggers’ natural curiosity is what
		makes them great at what they do. If you blog for a living,
		you have to be comfortable jumping from one topic to the
		next, even if you don’t know anything about it.
            </p>
            <div>
             <div class="flex flex-col sm:flex-row items-stretch sm:items-center flex-wrap gap-2.5 border-gray-300 border-t border-b border-dashed py-3 mb-4 mx-7.5" data-tabs="true">
              <button class="active group btn px-3 text-gray-700 hover:text-primary tab-active:bg-primary-light tab-active:border-primary-clarity tab-active:text-primary" data-tab-toggle="#post_4_comments">
               <i class="ki-filled ki-message-text text-gray-500 group-hover:text-primary tab-active:text-primary">
               </i>
               2 Comments
              </button>
              <button class="group btn px-3 text-gray-700 hover:text-primary tab-active:bg-primary-light tab-active:border-primary-clarity tab-active:text-primary" data-tab-toggle="#post_4_likes">
               <i class="ki-filled ki-heart text-gray-500 group-hover:text-primary tab-active:text-primary">
               </i>
               47k Likes
              </button>
              <button class="group btn px-3 text-gray-700 hover:text-primary tab-active:bg-primary-light tab-active:border-primary-clarity tab-active:text-primary" data-tab-toggle="#post_4_saves">
               <i class="ki-filled ki-archive-tick text-gray-500 group-hover:text-primary tab-active:text-primary">
               </i>
               900 Saves
              </button>
			...
			a great blog post in five simple steps that people will actually want to read. Ready?
             ...
             <div class="hidden" id="post_4_likes">
              <div class="flex flex-col gap-2 lg:gap-5 pt-3.5 px-7.5 mb-5">
               <div class="flex items-center flex-wrap gap-2">
                <div class="flex items-center grow gap-2.5">
                 <img alt="" class="rounded-full size-10 shrink-0" src="assets/media/avatars/300-14.png"/>
             ...
             <div class="hidden" id="post_4_saves">
              <style>
               .post-saves-bg {
		background-image: url('assets/media/images/2600x1200/bg-2.png');
		margin-top: -1rem;
