...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS CRM
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/profiles/crm" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="CRM public profile layout with Tailwind CSS utilities" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS CRM" name="twitter:title"/>
  <meta content="CRM public profile layout with Tailwind CSS utilities" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/public-profile/profiles/crm" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS CRM" property="og:title"/>
  <meta content="CRM public profile layout with Tailwind CSS utilities" property="og:description"/>
          ...
          <div class="grid gap-5 lg:gap-7.5">
           ...
           <div class="card">
            ...
            <div class="card-footer justify-center">
             <a class="btn btn-link" href="html/demo10/network/user-table/store-clients.html">
              All Attributes
             </a>
            </div>
           </div>
           <div class="card">
            ...
            <div class="card-body">
             <div class="text-sm text-gray-800 leading-5.5 pb-5">
             ...
             <div class="flex flex-col flex-wrap gap-4">
              <div class="input input-sm">
               <input type="text" value="hwewe4654fdd5sdfh"/>
            ...
            <div class="card-footer justify-center">
             <a class="btn btn-link" href="html/demo10/account/api-keys.html">
              Check API’s
             </a>
            </div>
           </div>
            ...
            <div class="card">
             ...
             <div class="card-table scrollable-x-auto">
              <table class="table text-end">
               <thead>
                <tr>
                 <th class="text-start min-w-[150px] !text-gray-700">
                  Deal Name
                 </th>
                 <th class="min-w-[100px] !text-gray-700">
                  Amount
                 </th>
                 <th class="min-w-[100px]">
                  Status
                 </th>
                 <th class="min-w-[110px] !text-gray-700">
                  Duration
                 </th>
                 <th class="w-[30px]">
                 </th>
             ...
             <div class="card-footer justify-center">
              <a class="btn btn-link" href="html/demo10/account/billing/history.html">
               All Deals
              </a>
             </div>
            </div>
               ...
               <div class="grid gap-5">
                <div class="flex justify-between gap-3">
                 <div class="flex items-center gap-2.5">
                  ...
                  <div class="flex flex-col gap-0.5">
                   <span class="text-2sm font-medium text-gray-900 cursor-pointer hover:text-primary mb-px">
                    INV-2023-001
                   </span>
