...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Billing - Basic
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/billing/basic" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Basic billing layout, styled with Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Billing - Basic" name="twitter:title"/>
  <meta content="Basic billing layout, styled with Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/billing/basic" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Billing - Basic" property="og:title"/>
  <meta content="Basic billing layout, styled with Tailwind CSS" property="og:description"/>
             ...
             <table class="table">
              <thead>
               <tr>
                ...
                <th class="min-w-24 text-end">
                 Status
                </th>
                <th class="min-w-32 text-end">
                 Date
                </th>
                <th class="min-w-20 text-end">
                 Amount
                </th>
                <th class="w-8">
                </th>
              ...
              <tbody>
               <tr>
                ...
                <td class="text-sm text-gray-800 font-normal lg:text-end">
                 6 Aug, 2024
                </td>
                <td class="text-sm text-gray-700 font-normal lg:text-end">
                 $24.00
                </td>
                <td>
                 <div class="btn btn-sm btn-icon btn-clear btn-primary">
                  <i class="ki-filled ki-exit-down">
                  </i>
                 </div>
                </td>
           ...
           <div class="card">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-discount text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
              <a class="text-base font-semibold text-gray-900 hover:text-primary" href="#">
               Tailor-Made Plans Selection and Efficient Billing Systems
              </a>
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-package text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
              <a class="text-base font-semibold text-gray-900 hover:text-primary" href="#">
               Customized Plans and Simple Billing Solutions
              </a>
              <p class="text-sm text-gray-700">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-cheque text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
              <a class="text-base font-semibold text-gray-900 hover:text-primary" href="#">
               Comprehensive Plan Options with Streamlined Billing
              </a>
              <p class="text-sm text-gray-700">
