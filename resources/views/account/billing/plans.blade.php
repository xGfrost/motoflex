...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Plans
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/billing/plans" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Subscription plans page, powered by Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Plans" name="twitter:title"/>
  <meta content="Subscription plans page, powered by Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/billing/plans" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Plans" property="og:title"/>
  <meta content="Subscription plans page, powered by Tailwind CSS" property="og:description"/>
       ...
       <div class="container-fixed">
        <div class="grid gap-5 lg:gap-7.5">
         <div class="scrollable-x-auto pt-3 -mt-3">
          <table class="table table-fixed min-w-[1000px] table-border-b table-border-e table-rounded card-rounded [&_tr:nth-of-type(2)&gt;td]:table-border-t [&_tr:nth-of-type(2)&gt;td:first-child]:card-rounded-ts">
           <tr>
            ...
            <td class="!border-b-0 table-border-s table-border-t card-rounded-ts bg-light-active dark:bg-coal-100 !p-5 !pt-7.5 relative">
             <span class="absolute badge badge-sm badge-outline badge-success absolutes top-0 start-1/2 rtl:translate-x-1/2 -translate-x-1/2 -translate-y-1/2">
              Current Plan
             </span>
             <h3 class="text-lg text-gray-900 font-medium pb-2">
              Basic
             </h3>
            ...
            <td class="!border-b-0 table-border-s table-border-t !p-5 !pt-7.5">
             <h3 class="text-lg text-gray-900 font-medium pb-2">
              Pro
             </h3>
             <div class="text-gray-700 text-2sm">
             ...
             <div class="py-4">
              <div class="flex items-end gap-1.5" data-plan-type="pro">
               <div class="text-2xl text-gray-900 font-semibold leading-none" data-plan-price-annual="$79" data-plan-price-regular="$99">
                $99
               </div>
               <div class="text-gray-700 text-2xs" data-plan-payment-annual="&gt;annual" data-plan-payment-regular="&gt;per month">
                per month
               </div>
              </div>
             </div>
            ...
            <td class="!border-b-0 table-border-s table-border-t !p-5 !pt-7.5">
             ...
             <div class="py-4">
              <div class="flex items-end gap-1.5" data-plan-type="premium">
               <div class="text-2xl text-gray-900 font-semibold leading-none" data-plan-price-annual="$179" data-plan-price-regular="$199">
                $199
               </div>
               <div class="text-gray-700 text-2xs" data-plan-payment-annual="&gt;annual" data-plan-payment-regular="&gt;per month">
                per month
            ...
            <td class="!border-b-0 table-border-s table-border-t card-rounded-te !p-5 !pt-7.5">
             <h3 class="text-lg text-gray-900 font-medium pb-2">
              Enterprise
             </h3>
             <div class="text-gray-700 text-2sm">
             ...
             <div class="py-4">
              <div class="flex items-end gap-1.5" data-plan-type="enterprise">
               <div class="text-2xl text-gray-900 font-semibold leading-none" data-plan-price-annual="$1,079" data-plan-price-regular="$1,299">
                $1,299
               </div>
               <div class="text-gray-700 text-2xs" data-plan-payment-annual="&gt;annual" data-plan-payment-regular="&gt;per month">
                per month
           ...
           <tr>
            <td class="table-border-s !px-5 !py-3.5">
             <div class="text-gray-900 text-2sm leading-none font-medium">
              User Accounts
             </div>
            </td>
            <td class="table-border-s bg-light-active dark:bg-coal-100 !px-5 !py-3.5">
          ...
          <div class="card">
           <div class="card-body px-10 py-7.5 lg:pr-12.5">
            <div class="flex flex-wrap md:flex-nowrap items-center gap-6 md:gap-10">
             ...
             <img alt="image" class="dark:hidden max-h-[150px]" src="assets/media/illustrations/2.svg"/>
             <img alt="image" class="light:hidden max-h-[150px]" src="assets/media/illustrations/2-dark.svg"/>
            </div>
           </div>
          ...
          <div class="card">
           <div class="card-body px-10 py-7.5 lg:pr-12.5">
            <div class="flex flex-wrap md:flex-nowrap items-center gap-6 md:gap-10">
             ...
             <img alt="image" class="dark:hidden max-h-[150px]" src="assets/media/illustrations/4.svg"/>
             <img alt="image" class="light:hidden max-h-[150px]" src="assets/media/illustrations/4-dark.svg"/>
            </div>
           </div>
           <div class="card-footer justify-center">
