...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Billing - Enterprise
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/billing/enterprise" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Enterprise billing layout using Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Billing - Enterprise" name="twitter:title"/>
  <meta content="Enterprise billing layout using Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/billing/enterprise" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Billing - Enterprise" property="og:title"/>
  <meta content="Enterprise billing layout using Tailwind CSS" property="og:description"/>
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
             ...
             <div class="flex flex-col gap-2">
              <div class="flex items-center flex-wrap sm:flex-nowrap gap-2.5">
               ...
               <span class="badge badge-sm badge-danger badge-outline shrink-0">
           ...
           <div class="card-body lg:py-7.5">
            <div class="flex flex-wrap gap-7.5">
             <div class="flex flex-col gap-3 items-center justify-center size-[140px] rounded-xl ring-1 ring-gray-200 bg-secondary-clarity">
              <img alt="" class="size-[70px]" src="assets/media/brand-logos/cloud-one.svg">
              ...
              <div class="flex flex-wrap items-center justify-between gap-2">
               <div class="flex flex-col gap-1">
                <div class="flex items-center flex-wrap sm:flex-nowrap gap-2.5">
                 ...
                 <span class="badge badge-sm badge-success badge-outline shrink-0">
                  Monthly Plan
                 </span>
                </div>
              ...
              <div class="flex flex-wrap gap-6 lg:gap-12">
               <div class="flex flex-col gap-3.5 grow">
                <div class="text-2sm text-gray-600">
                 UQuery runs:
                 <span class="text-2sm font-medium text-gray-900">
                  2239 of 10,000 used
                 </span>
                </div>
          ...
          <div class="card grow">
           ...
           <div class="card-body lg:7.5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
               ...
               <div class="flex flex-col">
                <a class="text-sm font-medium hover:text-primary text-gray-900" href="#">
                 on 17 Aug, 2024
                </a>
                <p class="text-2sm text-gray-700">
                 Due date
          ...
          <div class="card grow">
           ...
           <div class="card-body lg:pb-7.5">
            <div class="grid gap-5">
             ...
             <div class="flex items-center justify-between border border-gray-200 rounded-xl gap-2 px-4 py-4 bg-secondary-clarity">
              <div class="flex items-center gap-3.5">
               <img alt="" class="w-10 shrink-0" src="assets/media/brand-logos/ideal.svg"/>
               <div class="flex flex-col">
                <a class="text-sm font-medium text-gray-900 hover:text-primary-active mb-px" href="#">
                 Jason Tatum
                </a>
             ...
             <div class="flex items-center justify-between border border-gray-200 rounded-xl gap-2 px-4 py-4 bg-secondary-clarity">
              <div class="flex items-center gap-3.5">
               <img alt="" class="w-10 shrink-0" src="assets/media/brand-logos/paypal.svg"/>
               <div class="flex flex-col">
                <a class="text-sm font-medium text-gray-900 hover:text-primary-active mb-px" href="#">
                 Jason Tatum
                </a>
            ...
            <table class="table">
             ...
             <tbody>
              <tr>
               ...
               <td class="text-sm text-gray-800 lg:text-end">
                6 Aug, 2024
               </td>
               <td class="text-sm text-gray-800 lg:text-end">
                $24.00
