...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../">
  <title>
   Metronic - Tailwind CSS Integrations
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/integrations" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Integration pages with various services, using Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Integrations" name="twitter:title"/>
  <meta content="Integration pages with various services, using Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/integrations" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Integrations" property="og:title"/>
  <meta content="Integration pages with various services, using Tailwind CSS" property="og:description"/>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-7.5">
           <div class="card">
            <div class="card-body p-5 lg:p-7.5">
             ...
             <div class="flex flex-col gap-1 lg:gap-2.5">
              <a class="text-base font-smedium text-gray-900 hover:text-primary-active" href="html/demo10/account/billing/basic.html">
               Jira
              </a>
           ...
           <div class="card">
            <div class="card-body p-5 lg:p-7.5">
             ...
             <div class="flex flex-col gap-1 lg:gap-2.5">
              <a class="text-base font-smedium text-gray-900 hover:text-primary-active" href="html/demo10/account/billing/enterprise.html">
               Inferno
              </a>
              <span class="text-2sm text-gray-700">
           ...
           <div class="card">
            <div class="card-body p-5 lg:p-7.5">
             <div class="flex items-center justify-between mb-3 lg:mb-5">
              <div class="flex items-center justify-center">
               <img alt="" class="h-11 shrink-0" src="assets/media/brand-logos/evernote.svg"/>
              </div>
              <div class="btn btn-sm btn-icon btn-clear btn-light">
               <i class="ki-filled ki-exit-right-corner">
               </i>
             ...
             <div class="flex flex-col gap-1 lg:gap-2.5">
              <a class="text-base font-smedium text-gray-900 hover:text-primary-active" href="html/demo10/account/billing/plans.html">
               Evernote
              </a>
              <span class="text-2sm text-gray-700">
           ...
           <div class="card">
            <div class="card-body p-5 lg:p-7.5">
             <div class="flex items-center justify-between mb-3 lg:mb-5">
              <div class="flex items-center justify-center">
               <img alt="" class="h-11 shrink-0" src="assets/media/brand-logos/gitlab.svg"/>
              </div>
              <div class="btn btn-sm btn-icon btn-clear btn-light">
               <i class="ki-filled ki-exit-right-corner">
               </i>
             ...
             <div class="flex flex-col gap-1 lg:gap-2.5">
              <a class="text-base font-smedium text-gray-900 hover:text-primary-active" href="html/demo10/account/billing/history.html">
               Gitlab
              </a>
              <span class="text-2sm text-gray-700">
           ...
           <div class="card">
            <div class="card-body p-5 lg:p-7.5">
             <div class="flex items-center justify-between mb-3 lg:mb-5">
              <div class="flex items-center justify-center">
               <img alt="" class="h-11 shrink-0" src="assets/media/brand-logos/google-webdev.svg"/>
              </div>
              <div class="btn btn-sm btn-icon btn-clear btn-light">
               <i class="ki-filled ki-exit-right-corner">
               </i>
             ...
             <div class="flex flex-col gap-1 lg:gap-2.5">
              <a class="text-base font-smedium text-gray-900 hover:text-primary-active" href="html/demo10/account/security/get-started.html">
               Google webdev
              </a>
              <span class="text-2sm text-gray-700">
           ...
           <div class="card">
            <div class="card-body p-5 lg:p-7.5">
             <div class="flex items-center justify-between mb-3 lg:mb-5">
              <div class="flex items-center justify-center">
               <img alt="" class="h-11 shrink-0" src="assets/media/brand-logos/invision.svg"/>
              </div>
              <div class="btn btn-sm btn-icon btn-clear btn-light">
               <i class="ki-filled ki-exit-right-corner">
               </i>
             ...
             <div class="flex flex-col gap-1 lg:gap-2.5">
              <a class="text-base font-smedium text-gray-900 hover:text-primary-active" href="html/demo10/account/security/overview.html">
               Invision
              </a>
              <span class="text-2sm text-gray-700">
           ...
           <div class="card">
            <div class="card-body p-5 lg:p-7.5">
             <div class="flex items-center justify-between mb-3 lg:mb-5">
              <div class="flex items-center justify-center">
               <img alt="" class="h-11 shrink-0" src="assets/media/brand-logos/duolingo.svg"/>
              </div>
              <div class="btn btn-sm btn-icon btn-clear btn-light">
               <i class="ki-filled ki-exit-right-corner">
               </i>
             ...
             <div class="flex flex-col gap-1 lg:gap-2.5">
              <a class="text-base font-smedium text-gray-900 hover:text-primary-active" href="html/demo10/account/security/allowed-ip-addresses.html">
               Duolingo
              </a>
              <span class="text-2sm text-gray-700">
           ...
           <div class="card">
            <div class="card-body p-5 lg:p-7.5">
             <div class="flex items-center justify-between mb-3 lg:mb-5">
              <div class="flex items-center justify-center">
               <img alt="" class="h-11 shrink-0" src="assets/media/brand-logos/google-analytics-2.svg"/>
              </div>
              <div class="btn btn-sm btn-icon btn-clear btn-light">
               <i class="ki-filled ki-exit-right-corner">
               </i>
             ...
             <div class="flex flex-col gap-1 lg:gap-2.5">
              <a class="text-base font-smedium text-gray-900 hover:text-primary-active" href="html/demo10/account/security/privacy-settings.html">
               Google Analytics
              </a>
              <span class="text-2sm text-gray-700">
          ...
          <div class="card-body flex flex-col items-center gap-2.5 py-7.5">
           ...
           <div class="flex flex-col gap-5 lg:gap-7.5">
            ...
            <div class="flex justify-center mb-5">
             <a class="btn btn-primary" href="html/demo10/network/user-cards/mini-cards.html">
              Start Now
             </a>
            </div>
           </div>
