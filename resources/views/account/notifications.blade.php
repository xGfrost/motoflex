...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../">
  <title>
   Metronic - Tailwind CSS Notifications
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/notifications" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Notification management pages, powered by Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Notifications" name="twitter:title"/>
  <meta content="Notification management pages, powered by Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/notifications" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Notifications" property="og:title"/>
  <meta content="Notification management pages, powered by Tailwind CSS" property="og:description"/>
          ...
          <div class="flex flex-col gap-5 lg:gap-7.5">
           ...
           <div class="card">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-sms text-1.5xl text-gray-500">
                 </i>
                </div>
               </div>
               <div class="flex flex-col gap-0.5">
                ...
                <span class="text-2sm text-gray-700">
                 jamescollins@ktstudio.com
                </span>
               </div>
              </div>
              <div class="flex items-center gap-2 lg:gap-5">
               <a class="btn btn-xs btn-icon btn-primary btn-clear" href="#">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-phone text-1.5xl text-gray-500">
                 </i>
                </div>
               </div>
               <div class="flex flex-col gap-0.5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-slack text-1.5xl text-gray-500">
                 </i>
                </div>
               </div>
               <div class="flex flex-col gap-0.5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
               ...
               <div class="flex flex-col gap-0.5">
                ...
                <span class="text-2sm text-gray-700">
                 Enable notifications for real-time desktop alerts.
                </span>
               </div>
              </div>
              <div class="flex items-center gap-2 lg:gap-5">
           ...
           <div class="card">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-dollar text-1.5xl text-gray-500">
                 </i>
                </div>
               </div>
               <div class="flex flex-col gap-0.5">
                ...
                <span class="text-2sm text-gray-700">
                 Get notified if nearing budget limit.
                </span>
               </div>
              </div>
              <div class="flex items-center gap-2 lg:gap-5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-cheque text-1.5xl text-gray-500">
                 </i>
                </div>
               </div>
               <div class="flex flex-col gap-0.5">
                ...
                <span class="text-2sm text-gray-700">
                 Alert for new and unpaid invoices.
                </span>
               </div>
              </div>
              <div class="flex items-center gap-2 lg:gap-5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-message-text text-1.5xl text-gray-500">
                 </i>
                </div>
               </div>
               <div class="flex flex-col gap-0.5">
                ...
                <span class="text-2sm text-gray-700">
                 When a client submits new feedback.
                </span>
               </div>
              </div>
              <div class="flex items-center gap-2 lg:gap-5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
               ...
               <div class="flex flex-col gap-0.5">
                ...
                <span class="text-2sm text-gray-700">
                 Invite to collaborate on a new document.
                </span>
               </div>
              </div>
              <div class="flex items-center gap-2 lg:gap-5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-abstract-42 text-1.5xl text-gray-500">
                 </i>
                </div>
               </div>
               <div class="flex flex-col gap-0.5">
                ...
                <span class="text-2sm text-gray-700">
                 Reminder of scheduled meetings for the day.
                </span>
               </div>
              </div>
              <div class="flex items-center gap-2 lg:gap-5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-tablet-ok text-1.5xl text-gray-500">
                 </i>
                </div>
               </div>
               <div class="flex flex-col gap-0.5">
                ...
                <span class="text-2sm text-gray-700">
                 Notifies changes in project or task status.
                </span>
               </div>
              </div>
              <div class="flex items-center gap-2 lg:gap-5">
          ...
          <div class="flex flex-col gap-5 lg:gap-7.5">
           ...
           <div class="card">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-notification-on text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-message-notify text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
              <a class="text-base font-semibold text-gray-900 hover:text-primary" href="#">
               Effective Communication: Instant Notification Tools
              </a>
              <p class="text-sm text-gray-700">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-notification-status text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
              <a class="text-base font-semibold text-gray-900 hover:text-primary" href="#">
               Personalized Updates: Smart Alert System
              </a>
              <p class="text-sm text-gray-700">
