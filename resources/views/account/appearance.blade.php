...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../">
  <title>
   Metronic - Tailwind CSS Appearance
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/appearance" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Appearance settings page, powered by Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Appearance" name="twitter:title"/>
  <meta content="Appearance settings page, powered by Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/appearance" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Appearance" property="og:title"/>
  <meta content="Appearance settings page, powered by Tailwind CSS" property="og:description"/>
            ...
            <div class="card-body lg:py-7.5 py-5">
             <div class="flex flex-wrap justify-between gap-5">
              ...
              <div class="flex flex-wrap sm:flex-nowrap gap-5 lg:gap-7.5 max-w-96 w-full">
               ...
               <div class="flex bg-center w-full p-5 lg:p-7 bg-no-repeat bg-[length:550px] border border-gray-300 rounded-xl border-dashed branding-bg">
                <div class="flex flex-col place-items-center place-content-center text-center rounded-xl w-full">
                 ...
                 <a class="text-gray-900 text-xs font-medium hover:text-primary-active mb-px" href="html/demo10/network/user-cards/mini-cards.html">
                  Click or Drag & Drop
                 </a>
                 <span class="text-2xs text-gray-700 text-nowrap">
