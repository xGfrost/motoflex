...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Company Profile
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/home/company-profile" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Company profile page styled with Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Company Profile" name="twitter:title"/>
  <meta content="Company profile page styled with Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/home/company-profile" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Company Profile" property="og:title"/>
  <meta content="Company profile page styled with Tailwind CSS" property="og:description"/>
            ...
            <div class="card-table scrollable-x-auto pb-3">
             <table class="table align-middle text-sm text-gray-500" id="general_info_table">
              ...
              <tr>
               ...
               <td class="text-gray-800 text-2sm font-normal">
             ...
             <div class="scrollable-auto">
              <table class="table align-middle text-2sm text-gray-600">
               <tr class="bg-gray-100">
                <th class="text-start font-medium min-w-52">
                 Name
                </th>
                <th class="text-end font-medium min-w-36">
                 Role
                </th>
                <th class="text-end font-medium min-w-32">
                 2FA
                </th>
                <th class="text-end font-medium min-w-20">
                 Joined
                </th>
                <th class="min-w-16">
                </th>
               ...
               <tr>
                ...
                <td class="text-end text-gray-700 text-sm">
                 Today
                </td>
                <td class="text-end">
