...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Settings - Modal
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/home/settings-modal" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Modal settings page, using Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Settings - Modal" name="twitter:title"/>
  <meta content="Modal settings page, using Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/home/settings-modal" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Settings - Modal" property="og:title"/>
  <meta content="Modal settings page, using Tailwind CSS" property="og:description"/>
       ...
       <div class="bg-center bg-cover bg-no-repeat hero-bg">
        ...
        <div class="container-fixed">
         <div class="flex flex-col items-center gap-2 lg:gap-3.5 py-4 lg:pt-5 lg:pb-10">
          <img class="rounded-full border-3 border-success max-h-[100px] max-w-full" data-modal-toggle="#modal_profile" src="assets/media/avatars/300-1.png"/>
          <div class="flex items-center gap-1.5">
			...
			multiple platforms. Users log in once, gaining seamless entry
             ...
             <div class="card">
              ...
              <div class="card-body lg:py-7.5">
               ...
               <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-7.5">
                <div>
                 <label class="flex items-end border bg-no-repeat bg-cover border-gray-300 rounded-xl has-[:checked]:border-success has-[:checked]:border-3 [&_.checked]:has-[:checked]:flex h-[170px] mb-0.5" style="background-image: url('assets/media/images/600x400/28.jpg')">
                ...
                <div>
                 <label class="flex items-end border bg-no-repeat bg-cover border-gray-300 rounded-xl has-[:checked]:border-success has-[:checked]:border-3 [&_.checked]:has-[:checked]:flex h-[170px] mb-0.5" style="background-image: url('assets/media/images/600x400/32.jpg')">
                ...
                <div>
                 <label class="flex items-end border bg-no-repeat bg-cover border-gray-300 rounded-xl has-[:checked]:border-success has-[:checked]:border-3 [&_.checked]:has-[:checked]:flex h-[170px] mb-0.5" style="background-image: url('assets/media/images/600x400/30.jpg')">
                  <input class="appearance-none" name="appearance_option" type="radio" value="2"/>
                  <i class="ki-solid ki-check-circle checked ml-5 mb-5 text-xl text-success leading-none hidden">
                  </i>
                 </label>
