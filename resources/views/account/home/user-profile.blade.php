...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS User Profile
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/home/user-profile" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="User profile page, powered by Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS User Profile" name="twitter:title"/>
  <meta content="User profile page, powered by Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/home/user-profile" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS User Profile" property="og:title"/>
  <meta content="User profile page, powered by Tailwind CSS" property="og:description"/>
             ...
             <table class="table align-middle text-sm text-gray-500">
              <tr>
               ...
               <td class="py-2 min-w-60">
                <a class="text-gray-800 font-normal text-sm hover:text-primary-active" href="#">
                 jasontt@studio.co
                </a>
               </td>
              ...
              <tr>
               ...
               <td class="py-3.5 text-gray-700 font-normal">
                To be set
               </td>
              ...
              <tr>
               ...
               <td class="py-3 text-gray-700 font-normal">
                To be set
               </td>
               <td class="py-3 text-end">
                <a class="btn btn-link btn-sm" href="#">
              ...
              <tr>
               <td class="py-3 text-gray-600 text-sm font-normal">
                Referral Link
               </td>
               <td class="py-3 text-gray-700 text-2sm font-normal">
                <div class="flex items-center gap-0.5">
                 <a class="text-gray-800 text-sm hover:text-primary-active" href="#">
                  https://studio.co/W3gvQOI35dt
                 </a>
                 <button class="btn btn-xs btn-light btn-clear btn-icon">
                  <i class="ki-filled ki-copy text-gray-500 text-sm">
                  </i>
                 </button>
                </div>
               </td>
            ...
            <div class="card-table scrollable-x-auto pb-3">
             <table class="table align-middle text-sm text-gray-500">
              <tr>
               ...
               <td class="py-2 min-w-72 w-full text-gray-800 font-normal">
                English
              ...
              <tr>
               ...
               <td class="py-2 text-gray-800 font-normal">
                $28 / hour
               </td>
               <td class="py-2 text-end">
                <a class="btn btn-sm btn-icon btn-clear btn-primary" href="#">
              ...
              <tr>
               <td class="py-4 text-gray-600 font-normal">
                About
               </td>
               <td class="py-4 text-gray-800 font-normal">
           ...
           <div class="card">
            <div class="card-header gap-2">
             ...
             <div class="menu" data-menu="true">
              <div class="menu-item" data-menu-item-offset="0, 10px" data-menu-item-placement="bottom-end" data-menu-item-placement-rtl="bottom-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:click">
               <button class="menu-toggle btn btn-sm btn-icon btn-icon-lg text-gray-500 hover:text-primary-active">
            ...
            <div class="card-body pb-7.5">
             <div class="grid gap-2.5">
              <div class="flex items-center justify-between flex-wrap group border border-gray-200 rounded-xl gap-2 px-3.5 py-2.5">
		...
		background-image: url('assets/media/images/2600x1200/bg-5-dark.png');
           ...
           <div class="card flex-col gap-5 justify-between bg-[center_top_1.3rem] bg-no-repeat pt-5 lg:pt-10 px-5 start-now-bg bg-[length:700px]">
            <div class="text-center">
             ...
             <a class="btn btn-dark btn-sm" href="html/demo10/network/user-table/visitors.html">
              Start Now
             </a>
            </div>
            <div class="text-center">
               ...
               <tr>
                <td>
                 <div class="flex items-center grow gap-2.5">
                  ...
                  <div class="flex flex-col gap-1">
                   <a class="text-sm font-medium text-gray-900 hover:text-primary-active mb-px" href="html/demo10/public-profile/profiles/creator.html">
                    Tyler Hero
                   </a>
                   <span class="text-xs font-normal text-gray-700 leading-3">
                    26 connections
                   </span>
                  </div>
                 </div>
