...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Settings - Enterprise
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/home/settings-enterprise" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Enterprise settings page, powered by Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Settings - Enterprise" name="twitter:title"/>
  <meta content="Enterprise settings page, powered by Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/home/settings-enterprise" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Settings - Enterprise" property="og:title"/>
  <meta content="Enterprise settings page, powered by Tailwind CSS" property="og:description"/>
         ...
         <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-7.5">
          <div class="col-span-1">
           <div class="flex flex-col gap-5 lg:gap-7.5">
               ...
               <tr>
                ...
                <td class="text-gray-700 text-2sm font-normal">
                 <div class="flex items-center gap-1">
                  <a class="text-gray-800 font-normal text-2sm hover:text-primary-active" href="#">
            ...
            <div class="card">
             <div class="card-header gap-2" id="settings_auth_two_factor">
              <h3 class="card-title">
             ...
             <div class="card-body lg:py-7.5">
              <div class="grid gap-5">
               <div class="flex items-center justify-between flex-wrap lg:flex-nowrap border border-gray-200 rounded-xl gap-2 px-3.5 py-2.5">
            ...
            <div class="card">
             ...
             <div class="card-body lg:py-7.5 py-5">
              ...
              <a class="btn btn-sm btn-light" href="#">
               <img alt="" class="size-4 shrink-0" src="assets/media/brand-logos/google.svg"/>
          ...
          <div class="col-span-1">
           <div class="flex flex-col gap-5 lg:gap-7.5">
            <div class="card">
             ...
             <div class="card-body lg:py-7.5">
              <div class="flex flex-col sm:flex-row lg:flex-col xl:flex-row lg:gap-7.5 gap-5">
               <div class="md:flex-1 grid content-between border border-gray-200 rounded-xl">
                ...
                <div class="flex flex-col gap-2 p-5 pt-4">
                 <a class="text-base text-gray-900 font-medium hover:text-primary" href="#">
                  Premium Plan
                 </a>
                 <p class="text-2sm text-gray-700 mb-2">
               ...
               <div class="md:flex-1">
                <div class="flex flex-col lg:gap-7.5 gap-5">
                 <div class="flex flex-col items-start gap-2.5">
                  <a class="text-md text-gray-900 font-medium hover:text-primary" href="#">
                   DevOps Integration
                  </a>
            ...
            <div class="card">
             <div class="card-header gap-2" id="settings_set_goal">
              <h3 class="card-title">
               Set a Goal
              </h3>
              <div class="menu" data-menu="true">
              ...
              <table class="table">
               ...
               <tbody>
                <tr>
                 ...
                 <td class="text-sm font-normal text-gray-800 lg:text-right">
                  Subscription Fee
                 </td>
                 <td class="text-sm font-normal text-gray-800 lg:text-right">
                  $24.00
                ...
                <tr>
                 <td class="py-3.5">
                  <div class="flex items-center grow gap-2.5">
                   ...
                   <div class="flex flex-col gap-0.5">
                    <a class="text-sm font-smedium text-gray-900 hover:text-primary-active mb-px" href="#">
                     Tyler Hero
                    </a>
                 ...
                 <td class="py-2 text-right text-gray-600 font-nmedium">
                  6
                 </td>
                 <td class="py-2 text-right">
                  <button class="btn btn-xs btn-icon btn-primary rounded-full">
