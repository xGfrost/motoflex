...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Team Info
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/members/team-info" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Team information page, using Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Team Info" name="twitter:title"/>
  <meta content="Team information page, using Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/members/team-info" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Team Info" property="og:title"/>
  <meta content="Team information page, using Tailwind CSS" property="og:description"/>
                ...
                <div class="image-input size-16" data-image-input="true">
                 <input accept=".png, .jpg, .jpeg" name="avatar" type="file">
                  ...
                  <div class="image-input-placeholder rounded-full border-2 border-success image-input-empty:border-gray-300" style="background-image:url(assets/media/avatars/blank.png)">
                   <div class="image-input-preview rounded-full" style="background-image:url(assets/media/images/600x600/23.jpg)">
                   </div>
           ...
           <div class="card">
            <div class="card-body px-10 py-7.5 lg:pr-12.5">
             <div class="flex flex-wrap md:flex-nowrap items-center gap-6 md:gap-10">
              ...
              <img alt="image" class="dark:hidden max-h-44" src="assets/media/illustrations/29.svg"/>
              <img alt="image" class="light:hidden max-h-44" src="assets/media/illustrations/29-dark.svg"/>
             </div>
            </div>
         ...
         <div class="col-span-1">
          <div class="flex flex-col gap-5 lg:gap-7.5">
           <div class="card">
            ...
            <div class="card-body flex flex-col gap-2.5">
             ...
             <p class="text-2sm text-gray-800">
              Additional seats have been added, yet availability remains limited – secure yours quickly today.
             </p>
             <div>
           ...
           <div class="card">
            <div class="card-header">
             <h3 class="card-title">
              2 Profiles Connected
             </h3>
            </div>
            <div class="card-group flex justify-between items-center py-4">
             ...
             <div class="flex items-center gap-1.5">
              <img alt="" class="dark:hidden max-h-5" src="assets/media/brand-logos/x.svg"/>
              <img alt="" class="light:hidden max-h-5" src="assets/media/brand-logos/x-dark.svg"/>
            ...
            <div class="card-group flex justify-between items-center py-4">
             ...
             <div class="flex items-center gap-1.5">
              <img alt="" class="max-h-5" src="assets/media/brand-logos/google.svg"/>
              <div class="menu inline-flex" data-menu="true">
               <div class="menu-item" data-menu-item-offset="0, 10px" data-menu-item-placement="bottom-end" data-menu-item-placement-rtl="bottom-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:click">
                <button class="menu-toggle btn btn-sm btn-icon btn-light btn-clear">
                 <i class="ki-filled ki-dots-vertical">
           ...
           <div class="card">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
              ...
              <a class="text-base font-semibold text-gray-900 hover:text-primary" href="#">
               Centralizing Team Profiles: Management and Directory Tools
              </a>
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-profile-circle text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
              <a class="text-base font-semibold text-gray-900 hover:text-primary" href="#">
               Building a Cohesive Team: Resources for Profile Compilation
              </a>
              <p class="text-sm text-gray-700">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-questionnaire-tablet text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
