...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Import Members
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/members/import-members" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Import members page, styled with Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Import Members" name="twitter:title"/>
  <meta content="Import members page, styled with Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/members/import-members" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Import Members" property="og:title"/>
  <meta content="Import members page, styled with Tailwind CSS" property="og:description"/>
         ...
         <div class="col-span-2">
          <div class="flex flex-col gap-5 lg:gap-7.5">
           <div class="card">
            ...
            <div class="card-body grid gap-7.5 py-5 lg:py-7.5">
             <div class="flex flex-col gap-2.5">
              <label class="checkbox-group">
               <input checked="" class="checkbox checkbox-sm" name="option" type="checkbox" value="1"/>
               <span class="checkbox-label text-gray-800 font-medium">
                Create new users
               </span>
              </label>
             ...
             <div class="flex flex-col gap-2.5">
              <label class="checkbox-group">
               <input class="checkbox checkbox-sm" name="option" type="checkbox" value="2"/>
               <span class="checkbox-label text-gray-800 font-medium">
             ...
             <div class="flex flex-col gap-2.5">
              <label class="checkbox-group">
               <input checked="" class="checkbox checkbox-sm" name="option" type="checkbox" value="3"/>
               <span class="checkbox-label text-gray-800 font-medium">
             ...
             <div class="flex flex-col gap-2.5">
              <label class="checkbox-group">
               <input class="checkbox checkbox-sm" name="option" type="checkbox" value="4"/>
               <span class="checkbox-label text-gray-800 font-medium">
                Include external IDs in import results
               </span>
              </label>
              <p class="form-info leading-5 text-gray-800 font-normal">
             ...
             <div class="flex flex-col gap-2.5">
              <div class="flex gap-2.5">
               ...
               <button class="btn btn-sm btn-clear btn-light">
                Choose File
               </button>
              </div>
             ...
             <div class="flex flex-col gap-4">
              ...
              <textarea class="textarea text-2sm text-gray-600 font-normal" name="message" rows="5">Your welcome message here</textarea>
              <label class="flex items-center gap-1.5">
               <input class="checkbox checkbox-sm" name="send" type="checkbox" value="1"/>
               <span class="text-gray-800 text-2sm font-medium">
            ...
            <div class="card-footer justify-center py-3.5">
             <button class="btn btn-sm btn-primary">
              Import Member
             </button>
            </div>
           ...
           <div class="card">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-people text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-exit-up text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-mouse-circle text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
