...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Team Members
  </title>
  <meta charset="utf-8"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/members/team-members" property="og:url"/>
          ...
          <form class="card">
           ...
           <div class="card-body grid gap-5">
            <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
             ...
             <input class="input" name="user_email" placeholder="" type="text" value="jason@studio.io"/>
            </div>
