...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Roles
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/members/roles" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Roles management page, powered by Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Roles" name="twitter:title"/>
  <meta content="Roles management page, powered by Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/members/roles" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Roles" property="og:title"/>
  <meta content="Roles management page, powered by Tailwind CSS" property="og:description"/>
   ...
   <div class="flex flex-col lg:flex-row grow pt-[--tw-header-height] lg:pt-0">
         ...
         <div class="card flex flex-col gap-5 p-5 lg:p-7.5">
          <div class="flex items-center flex-wrap justify-between gap-1">
           <div class="flex items-center gap-2.5">
            ...
            <div class="flex flex-col">
             <a class="text-md font-medium text-gray-900 hover:text-primary-active mb-px" href="html/demo10/public-profile/profiles/creator.html">
              Administrator
             </a>
         ...
         <div class="card flex flex-col gap-5 p-5 lg:p-7.5">
          <div class="flex items-center flex-wrap justify-between gap-1">
           <div class="flex items-center gap-2.5">
            ...
            <div class="flex flex-col">
             <a class="text-md font-medium text-gray-900 hover:text-primary-active mb-px" href="html/demo10/public-profile/profiles/company.html">
              Viewer
             </a>
             <span class="text-2sm text-gray-700">
              Default role
         ...
         <div class="card flex flex-col gap-5 p-5 lg:p-7.5">
          <div class="flex items-center flex-wrap justify-between gap-1">
           <div class="flex items-center gap-2.5">
            ...
            <div class="flex flex-col">
             <a class="text-md font-medium text-gray-900 hover:text-primary-active mb-px" href="html/demo10/public-profile/profiles/nft.html">
              Remote Developer
             </a>
             <span class="text-2sm text-gray-700">
              Remote role
         ...
         <div class="card flex flex-col gap-5 p-5 lg:p-7.5">
          <div class="flex items-center flex-wrap justify-between gap-1">
           <div class="flex items-center gap-2.5">
            ...
            <div class="flex flex-col">
             <a class="text-md font-medium text-gray-900 hover:text-primary-active mb-px" href="html/demo10/public-profile/profiles/blogger.html">
              Customer Support
             </a>
             <span class="text-2sm text-gray-700">
              Default role
         ...
         <div class="card flex flex-col gap-5 p-5 lg:p-7.5">
          <div class="flex items-center flex-wrap justify-between gap-1">
           <div class="flex items-center gap-2.5">
            ...
            <div class="flex flex-col">
             <a class="text-md font-medium text-gray-900 hover:text-primary-active mb-px" href="html/demo10/public-profile/profiles/crm.html">
              Project Manager
             </a>
             <span class="text-2sm text-gray-700">
              Default role
         ...
         <div class="card flex flex-col gap-5 p-5 lg:p-7.5">
          <div class="flex items-center flex-wrap justify-between gap-1">
           <div class="flex items-center gap-2.5">
            ...
            <div class="flex flex-col">
             <a class="text-md font-medium text-gray-900 hover:text-primary-active mb-px" href="html/demo10/public-profile/profiles/gamer.html">
              Remote Designer
             </a>
             <span class="text-2sm text-gray-700">
              Remote role
         ...
         <div class="card flex flex-col gap-5 p-5 lg:p-7.5">
          <div class="flex items-center flex-wrap justify-between gap-1">
           <div class="flex items-center gap-2.5">
            ...
            <div class="flex flex-col">
             <a class="text-md font-medium text-gray-900 hover:text-primary-active mb-px" href="html/demo10/public-profile/profiles/feeds.html">
              HR Manager
             </a>
             <span class="text-2sm text-gray-700">
              Default role
	...
	.dark .add-new-bg {
		background-image: url('assets/media/images/2600x1200/bg-4-dark.png');
         ...
         <a class="card border-2 border-dashed border-brand-clarity bg-center bg-[length:600px] bg-no-repeat add-new-bg" href="html/demo10/public-profile/works.html">
