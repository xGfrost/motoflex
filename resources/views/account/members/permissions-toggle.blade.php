...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  <title>
   Metronic - Tailwind CSS Permissions - Toggler
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/members/permissions-toggle" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Permissions toggler page, using Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Permissions - Toggler" name="twitter:title"/>
  <meta content="Permissions toggler page, using Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/members/permissions-toggle" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Permissions - Toggler" property="og:title"/>
  <meta content="Permissions toggler page, using Tailwind CSS" property="og:description"/>
       ...
       <div class="container-fixed">
        <div class="grid gap-5 lg:gap-7.5">
         <div class="card">
          ...
          <div class="card-body grid grid-cols-1 lg:grid-cols-2 gap-5 py-5 lg:py-7.5">
           ...
           <div class="rounded-xl border p-4 flex items-center justify-between gap-2.5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
              ...
              <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
               <i class="ki-filled ki-two-credit-cart text-lg text-gray-500">
               </i>
              </div>
             </div>
             <div class="flex flex-col gap-1">
            ...
            <div class="switch switch-sm">
             <input name="param" type="checkbox" value="2"/>
            </div>
           </div>
           <div class="rounded-xl border p-4 flex items-center justify-between gap-2.5">
            <div class="flex items-center gap-3.5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
              ...
              <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
               <i class="ki-filled ki-mouse-square text-lg text-gray-500">
               </i>
              </div>
             </div>
             <div class="flex flex-col gap-1">
            ...
            <div class="switch switch-sm">
             <input checked="" name="param" type="checkbox" value="3"/>
            </div>
           </div>
           <div class="rounded-xl border p-4 flex items-center justify-between gap-2.5">
            <div class="flex items-center gap-3.5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
              ...
              <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
               <i class="ki-filled ki-toggle-off-circle text-lg text-gray-500">
               </i>
              </div>
             </div>
             <div class="flex flex-col gap-1">
            ...
            <div class="switch switch-sm">
             <input name="param" type="checkbox" value="4"/>
            </div>
           </div>
           <div class="rounded-xl border p-4 flex items-center justify-between gap-2.5">
            <div class="flex items-center gap-3.5">
            ...
            <div class="switch switch-sm">
             <input name="param" type="checkbox" value="5"/>
            </div>
           </div>
           <div class="rounded-xl border p-4 flex items-center justify-between gap-2.5">
            <div class="flex items-center gap-3.5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
              ...
              <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
               <i class="ki-filled ki-exit-up text-lg text-gray-500">
               </i>
              </div>
             </div>
             <div class="flex flex-col gap-1">
            ...
            <div class="switch switch-sm">
             <input checked="" name="param" type="checkbox" value="6"/>
            </div>
           </div>
           <div class="rounded-xl border p-4 flex items-center justify-between gap-2.5">
            <div class="flex items-center gap-3.5">
            ...
            <div class="switch switch-sm">
             <input checked="" name="param" type="checkbox" value="7"/>
            </div>
           </div>
           <div class="rounded-xl border p-4 flex items-center justify-between gap-2.5">
            <div class="flex items-center gap-3.5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
              ...
              <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
               <i class="ki-filled ki-shield-tick text-lg text-gray-500">
               </i>
              </div>
             </div>
             <div class="flex flex-col gap-1">
            ...
            <div class="switch switch-sm">
             <input checked="" name="param" type="checkbox" value="8"/>
            </div>
           </div>
           <div class="rounded-xl border p-4 flex items-center justify-between gap-2.5">
            <div class="flex items-center gap-3.5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
              ...
              <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
               <i class="ki-filled ki-key-square text-lg text-gray-500">
               </i>
              </div>
             </div>
             <div class="flex flex-col gap-1">
            ...
            <div class="switch switch-sm">
             <input name="param" type="checkbox" value="9"/>
            </div>
           </div>
           <div class="rounded-xl border p-4 flex items-center justify-between gap-2.5">
            <div class="flex items-center gap-3.5">
            ...
            <div class="switch switch-sm">
             <input name="param" type="checkbox" value="10"/>
            </div>
           </div>
          </div>
