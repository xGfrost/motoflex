...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/security/get-started" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Get started with security settings, styled with Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Get Started" name="twitter:title"/>
  <meta content="Get started with security settings, styled with Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/security/get-started" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Get Started" property="og:title"/>
  <meta content="Get started with security settings, styled with Tailwind CSS" property="og:description"/>
       ...
       <div class="container-fixed">
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-7.5">
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           ...
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10/account/security/overview/index.html">
             Overview
            </a>
         ...
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           <div class="flex items-center justify-between gap-2">
            <i class="ki-filled ki-icon text-2xl link">
            </i>
           </div>
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10/account/security/allowed-ip-addresses/index.html">
             Allowed IP Addresses
            </a>
            <span class="text-2sm text-gray-700 leading-5">
         ...
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           <div class="flex items-center justify-between gap-2">
            <i class="ki-filled ki-setting text-2xl link">
            </i>
           </div>
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10/account/security/privacy-settings/index.html">
             Privacy Settings
            </a>
            <span class="text-2sm text-gray-700 leading-5">
         ...
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           ...
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10/account/security/device-management/index.html">
             Trusted Devices
            </a>
            <span class="text-2sm text-gray-700 leading-5">
         ...
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           ...
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10/account/security/backup-and-recovery/index.html">
             Backup & Recovery
            </a>
            <span class="text-2sm text-gray-700 leading-5">
         ...
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           ...
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10/account/security/current-sessions/index.html">
             Login Sessions
            </a>
            <span class="text-2sm text-gray-700 leading-5">
         ...
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           <div class="flex items-center justify-between gap-2">
            <i class="ki-filled ki-shield-slash text-2xl link">
            </i>
           </div>
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10/account/security/security-log/index.html">
             Security Log
            </a>
            <span class="text-2sm text-gray-700 leading-5">
