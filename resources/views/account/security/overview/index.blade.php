...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../../">
  <title>
   Metronic - Tailwind CSS Security Overview
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/security/overview/index.html" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Overview of security settings, powered by Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Security Overview" name="twitter:title"/>
  <meta content="Overview of security settings, powered by Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/security/overview/index.html" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Security Overview" property="og:title"/>
  <meta content="Overview of security settings, powered by Tailwind CSS" property="og:description"/>
          ...
          <div class="flex flex-col gap-5 lg:gap-7.5">
           <div class="card">
            <div class="card-body px-10 py-7.5 lg:pe-12.5">
             <div class="flex flex-wrap xl:flex-nowrap items-center justify-between gap-6 md:gap-10 p-2.5">
              ...
              <div class="shrink-0">
               <img alt="image" class="dark:hidden max-h-36" src="assets/media/illustrations/5.svg"/>
               <img alt="image" class="light:hidden max-h-36" src="assets/media/illustrations/5-dark.svg"/>
              </div>
             </div>
            </div>
           ...
           <div class="card">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
               ...
               <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                <i class="ki-filled ki-people text-1.5xl text-gray-500">
                </i>
               </div>
              </div>
              <div class="flex flex-col gap-0.5">
               ...
               <span class="text-2sm text-gray700">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
               ...
               <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                <i class="ki-filled ki-abstract-37 text-1.5xl text-gray-500">
                </i>
               </div>
              </div>
              <div class="flex flex-col gap-0.5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
               ...
               <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                <i class="ki-filled ki-geolocation text-1.5xl text-gray-500">
                </i>
               </div>
              </div>
              <div class="flex flex-col gap-0.5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
               ...
               <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                <i class="ki-filled ki-shield-tick text-1.5xl text-gray-500">
                </i>
               </div>
              </div>
              <div class="flex flex-col gap-0.5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
               ...
               <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                <i class="ki-filled ki-badge text-1.5xl text-gray-500">
                </i>
               </div>
              </div>
              <div class="flex flex-col gap-0.5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
               ...
               <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                <i class="ki-filled ki-check-circle text-1.5xl text-gray-500">
                </i>
               </div>
              </div>
              <div class="flex flex-col gap-0.5">
            ...
            <div class="card-table scrollable-x-auto pb-3">
             <table class="table align-middle text-sm text-gray-500">
              <tr>
               ...
               <td class="text-end">
                <a class="btn btn-sm btn-icon btn-icon-lg link" href="#">
              ...
              <tr>
               ...
               <td>
                <div class="flex items-center gap-2.5">
                 <a class="flex items-center justify-center size-8 bg-light rounded-full border border-gray-300" href="#">
                 ...
                 <a class="flex items-center justify-center size-8 bg-light rounded-full border border-gray-300" href="#">
                  <img alt="" class="dark:hidden size-4" src="assets/media/brand-logos/apple-black.svg"/>
                  <img alt="" class="light:hidden size-4" src="assets/media/brand-logos/apple-white.svg"/>
                 </a>
                </div>
               </td>
               <td class="text-end">
           ...
           <div class="card">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
               ...
               <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                <i class="ki-filled ki-exit-right text-1.5xl text-gray-500">
                </i>
               </div>
              </div>
              <div class="flex flex-col gap-0.5">
           ...
           <div class="card min-w-full">
            ...
            <div class="card-table scrollable-x-auto">
             <div class="scrollable-auto">
              <table class="table align-middle text-gray-700 text-sm">
               <thead>
                <tr>
                 <th class="text-start min-w-48">
                  Name
                 </th>
                 <th class="text-end min-w-20">
                  Location
                 </th>
                 <th class="text-end min-w-20">
                  Recent activity
                 </th>
                 <th class="text-end w-[70px]">
                 </th>
                </tr>
               </thead>
               <tbody>
                <tr>
                 <td>
                  <div class="flex items-center grow gap-2.5">
                   <div class="">
                    <img class="rounded-full size-9 shrink-0" src="assets/media/avatars/300-3.png"/>
                   </div>
                   <div class="flex flex-col gap-0.5">
                    <a class="text-sm font-medium text-gray-900 hover:text-primary-actives" href="#">
                     Tyler Hero
                    </a>
                 ...
                 <td class="text-end text-gray-700 font-normal">
                  New Zealand
                 </td>
                 <td class="text-end text-gray-700 font-normal">
                  Current session
                ...
                <tr>
                 <td>
                  <div class="flex items-center grow gap-2.5">
                   <div class="">
                    <img class="rounded-full size-9 shrink-0" src="assets/media/avatars/300-1.png"/>
                   </div>
                   <div class="flex flex-col gap-0.5">
                    <a class="text-sm font-medium text-gray-900 hover:text-primary-actives" href="#">
                     Esther Howard
                ...
                <tr>
                 <td>
                  <div class="flex items-center grow gap-2.5">
                   <div class="">
                    <img class="rounded-full size-9 shrink-0" src="assets/media/avatars/300-11.png"/>
                   </div>
                   <div class="flex flex-col gap-0.5">
                    <a class="text-sm font-medium text-gray-900 hover:text-primary-actives" href="#">
                     Jacob Jones
                ...
                <tr>
                 <td>
                  <div class="flex items-center grow gap-2.5">
                   <div class="">
                    <img class="rounded-full size-9 shrink-0" src="assets/media/avatars/300-2.png"/>
                   </div>
                   <div class="flex flex-col gap-0.5">
                    <a class="text-sm font-medium text-gray-900 hover:text-primary-actives" href="#">
                     Cody Fisher
                ...
                <tr>
                 <td>
                  <div class="flex items-center grow gap-2.5">
                   <div class="">
                    <img class="rounded-full size-9 shrink-0" src="assets/media/avatars/300-5.png"/>
                   </div>
                   <div class="flex flex-col gap-0.5">
                    <a class="text-sm font-medium text-gray-900 hover:text-primary-actives" href="#">
                     Leslie Alexander
           ...
           <div class="card min-w-full">
            ...
            <div class="card-table scrollable-x-auto">
             <div class="scrollable-auto">
              <table class="table align-middle text-gray-600 font-medium text-2sm">
               <tbody>
                <tr>
                 <td class="min-w-48 w-48">
                  <div class="flex items-center gitem gap-2.5">
                   <img alt="image" class="h-6" src="assets/media/brand-logos/chrome.svg"/>
                   <div class="flex flex-col">
                    ...
                    <div class="flex gap-1.5">
                     ...
                     <img alt="image" class="h-3.5 rounded-full" src="assets/media/flags/spain.svg"/>
                    </div>
                   </div>
                  </div>
                 </td>
                 <td class="min-w-56 text-gray-700 font-normal">
                  MacOS 12.19.6
                  <br/>
                  Active: Today at 9:03 AM
                 </td>
                 <td class="!pr-7.5 min-w-16 text-end">
                  <a class="btn btn-sm btn-icon btn-light btn-clear" href="#">
                   <i class="ki-filled ki-exit-right">
                   </i>
                  </a>
                 </td>
                  ...
                  <div class="flex items-center gitem gap-2.5">
                   ...
                   <div class="flex flex-col">
                    ...
                    <div class="flex gap-1.5">
                     ...
                     <img alt="image" class="h-3.5 rounded-full" src="assets/media/flags/france.svg"/>
                    </div>
                   </div>
                  </div>
                 </td>
          ...
          <div class="flex flex-col gap-5 lg:gap-7.5">
           <div class="card p-5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
               ...
               <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                <img alt="" class="dark:hidden h-5" src="assets/media/brand-logos/apple-black.svg"/>
                <img alt="" class="light:hidden h-5" src="assets/media/brand-logos/apple-white.svg"/>
               </div>
              </div>
              <div class="flex flex-col gap-0.5">
               <span class="leading-none font-medium text-base text-gray-900">
                iOS
               </span>
               <span class="text-2sm text-gray-700">
                Active Sessions
           ...
           <div class="card p-5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
               ...
               <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                <img alt="" class="h-5" src="assets/media/brand-logos/android.svg"/>
               </div>
              </div>
              <div class="flex flex-col gap-0.5">
               <span class="leading-none font-medium text-base text-gray-900">
           ...
           <div class="card">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-shield-slash text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-ensure text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-shield-search text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
