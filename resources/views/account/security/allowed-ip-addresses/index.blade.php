...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../../">
  <title>
   Metronic - Tailwind CSS Allowed IP Addresses
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/security/allowed-ip-addresses/index.html" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Manage allowed IP addresses with Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Allowed IP Addresses" name="twitter:title"/>
  <meta content="Manage allowed IP addresses with Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/security/allowed-ip-addresses/index.html" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Allowed IP Addresses" property="og:title"/>
  <meta content="Manage allowed IP addresses with Tailwind CSS" property="og:description"/>
 ...
 <body class="antialiased flex h-full text-base text-gray-700 [--tw-page-bg:var(--tw-coal-300)] [--tw-content-bg:var(--tw-light)] [--tw-content-bg-dark:var(--tw-coal-500)] [--tw-content-scrollbar-color:#e8e8e8] [--tw-header-height:60px] [--tw-sidebar-width:270px] bg-[--tw-page-bg] lg:overflow-hidden">
         ...
         <div class="card card-grid min-w-full">
          <div class="card-header">
           ...
           <div class="flex gap-5">
            ...
            <a class="btn btn-sm btn-primary" href="#" id="select_ip_btn">
             Add IP Address
            </a>
           </div>
          </div>
          <div class="card-body">
           <div id="ip_addresses_table">
             ...
             <table class="table table-border" data-datatable-table="true">
              <thead>
               <tr>
                ...
                <th class="min-w-[170px]" data-datatable-column="ipAddress">
                 <span class="sort">
                  <span class="sort-label">
                   IP Address
                  </span>
  ...
  <script src="assets/js/datatables/allowed-ip-addresses.js">
  </script>
  <!-- End of Scripts -->
 </body>
</html>
