...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../../">
  <title>
   Metronic - Tailwind CSS Device Management
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/security/device-management/index.html" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Manage devices with Tailwind CSS for better security" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Device Management" name="twitter:title"/>
  <meta content="Manage devices with Tailwind CSS for better security" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/security/device-management/index.html" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Device Management" property="og:title"/>
  <meta content="Manage devices with Tailwind CSS for better security" property="og:description"/>
                 ...
                 <span class="sort">
                  <span class="sort-label text-gray-700 text-2sm font-normal">
                   <span class="pt-px" data-tooltip="true" data-tooltip-offset="0, 5" data-tooltip-placement="left">
                    <i class="ki-filled ki-information-2 text-lg leading-none">
                    </i>
              ...
              <tbody>
                ...
                <td>
                 <div class="flex items-center gap-4">
                  <div class="leading-none w-5 shrink-0">
                   <i class="ki-filled ki-screen text-gray-500 text-2xl">
                   </i>
                  </div>
                  <div class="flex flex-col gap-0.5">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-4">
                  <div class="leading-none w-5 shrink-0">
                   <i class="ki-filled ki-phone text-gray-500 text-2xl">
                   </i>
                  </div>
                  <div class="flex flex-col gap-0.5">
                   <span class="leading-none font-medium text-sm text-gray-900">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-4">
                  <div class="leading-none w-5 shrink-0">
                   <i class="ki-filled ki-devices text-gray-500 text-2xl">
                   </i>
                  </div>
                  <div class="flex flex-col gap-0.5">
                   <span class="leading-none font-medium text-sm text-gray-900">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-4">
                  <div class="leading-none w-5 shrink-0">
                   <i class="ki-filled ki-laptop text-gray-500 text-2xl">
                   </i>
                  </div>
                  <div class="flex flex-col gap-0.5">
                   <span class="leading-none font-medium text-sm text-gray-900">
               ...
               <tr>
                ...
                <td>
                 <div class="flex items-center gap-4">
                  <div class="leading-none w-5 shrink-0">
                   <i class="ki-filled ki-tablet text-gray-500 text-2xl">
                   </i>
                  </div>
                  <div class="flex flex-col gap-0.5">
                   <span class="leading-none font-medium text-sm text-gray-900">
