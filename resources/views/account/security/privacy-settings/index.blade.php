...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../../">
  <title>
   Metronic - Tailwind CSS Privacy Settings
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/security/privacy-settings/index.html" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Privacy settings page, using Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Privacy Settings" name="twitter:title"/>
  <meta content="Privacy settings page, using Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/security/privacy-settings/index.html" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Privacy Settings" property="og:title"/>
  <meta content="Privacy settings page, using Tailwind CSS" property="og:description"/>
           ...
           <div class="card">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
               ...
               <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                <i class="ki-filled ki-search-list text-1.5xl text-gray-500">
                </i>
               </div>
              </div>
              <div class="flex flex-col gap-1.5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
               ...
               <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                <i class="ki-filled ki-message-notify text-1.5xl text-gray-500">
                </i>
               </div>
              </div>
              <div class="flex flex-col gap-1.5">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
               ...
               <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                <i class="ki-filled ki-discount text-1.5xl text-gray-500">
                </i>
               </div>
              </div>
              <div class="flex flex-col gap-1.5">
               ...
               <span class="text-2sm text-gray-700">
                Customize how ads are targeted to your interests.
               </span>
              </div>
             </div>
             <div class="flex items-center gap-2.5">
           ...
           <div class="grid lg:grid-cols-2 gap-5 lg:gap-7.5">
            <div class="card">
             ...
             <label class="card-group flex items-center justify-between py-4 gap-2.5">
              ...
              <input checked="" class="radio" name="sharing-setting" type="radio" value="1"/>
             </label>
             <label class="card-group flex items-center justify-between py-4 gap-2.5">
              <div class="flex flex-col justify-center gap-1.5">
               <span class="leading-none font-medium text-sm text-gray-900">
              ...
              <input class="radio" name="sharing-setting" type="radio" value="2"/>
             </label>
             <label class="card-group flex items-center justify-between py-4 gap-2.5">
              <div class="flex flex-col justify-center gap-1.5">
               <span class="leading-none font-medium text-sm text-gray-900">
              ...
              <input class="radio" name="sharing-setting" type="radio" value="3"/>
             </label>
            </div>
            <div class="card">
             <div class="card-header">
          ...
          <div class="flex flex-col gap-5 lg:gap-7.5">
           ...
           <div class="card">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-setting text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
              <a class="text-base font-semibold text-gray-900 hover:text-primary" href="#">
               Navigating Privacy Preferences: Secure Configuration Tools
              </a>
              <p class="text-sm text-gray-700">
