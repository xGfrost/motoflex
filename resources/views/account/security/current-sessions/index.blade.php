...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../../">
  <title>
   Metronic - Tailwind CSS Current Sessions
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/security/current-sessions/index.html" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Current sessions management, using Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Current Sessions" name="twitter:title"/>
  <meta content="Current sessions management, using Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/security/current-sessions/index.html" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Current Sessions" property="og:title"/>
  <meta content="Current sessions management, using Tailwind CSS" property="og:description"/>
 ...
 <body class="antialiased flex h-full text-base text-gray-700 [--tw-page-bg:var(--tw-coal-300)] [--tw-content-bg:var(--tw-light)] [--tw-content-bg-dark:var(--tw-coal-500)] [--tw-content-scrollbar-color:#e8e8e8] [--tw-header-height:60px] [--tw-sidebar-width:270px] bg-[--tw-page-bg] lg:overflow-hidden">
       ...
       <div class="container-fixed">
        <div class="grid gap-5 lg:gap-7.5">
         <div class="card card-grid min-w-full">
          <div class="card-header py-5 flex-wrap gap-2">
           ...
           <div class="flex flex-wrap gap-5">
            ...
            <div class="flex gap-3">
             ...
             <select class="select select-sm min-w-32">
              <option>
               All Locations
              </option>
              <option value="uk">
          ...
          <div class="card-body">
           <div data-datatable="false" id="current_sessions_table">
             ...
             <table class="table table-border" data-datatable-table="true">
              <thead>
               <tr>
                ...
                <th class="min-w-[300px]" data-datatable-column="user" data-datatable-column-sort="user.name">
                 <span class="sort asc">
                ...
                <th class="min-w-[240px]" data-datatable-column="browser" data-datatable-column-sort="browser.name">
                 <span class="sort">
                  <span class="sort-label">
                   Browser
                  </span>
                ...
                <th class="w-[240px]" data-datatable-column="ipAddress">
                 <span class="sort">
                  <span class="sort-label">
                   IP Address
                  </span>
                ...
                <th class="w-[200px]" data-datatable-column="location" data-datatable-column-sort="location.name">
                 <span class="sort">
                  <span class="sort-label">
                   Location
                  </span>
  ...
  <script src="assets/js/datatables/current-sessions.js">
  </script>
  <!-- End of Scripts -->
 </body>
</html>
