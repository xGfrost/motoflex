...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../../">
  <title>
   Metronic - Tailwind CSS Backup & Recovery
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/security/backup-and-recovery/index.html" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Backup and recovery settings, powered by Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Backup & Recovery" name="twitter:title"/>
  <meta content="Backup and recovery settings, powered by Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/security/backup-and-recovery/index.html" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Backup & Recovery" property="og:title"/>
  <meta content="Backup and recovery settings, powered by Tailwind CSS" property="og:description"/>
            ...
            <div class="card-body">
             <div data-datatable="true" data-datatable-page-size="10">
              <div class="scrollable-x-auto">
               <table class="table table-border" data-datatable-table="true" id="backups_table">
                <thead>
                 <tr>
                  <th class="w-[60px]">
                ...
                <tbody>
                  ...
                  <td>
                   <div class="flex flex-col gap-1">
                    ...
                    <span class="flex items-center gap-2 text-xs text-gray-600 font-normal">
                     ...
                     <span class="flex items-center gap-1">
                      <i class="ki-filled ki-picture text-sm text-gray-500">
                      </i>
                      47 media
                     </span>
                    </span>
                 ...
                 <tr>
                  ...
                  <td>
                   <div class="flex flex-col gap-1">
                    <span class="leading-none font-medium text-sm text-gray-900">
                     Quick Data Backup - User Profiles
                    </span>
                    <span class="flex items-center gap-2 text-xs text-gray-600 font-normal">
                     <span class="flex items-center gap-1">
                      <i class="ki-filled ki-files text-sm text-gray-500">
           ...
           <div class="card">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-book text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
              <a class="text-base font-semibold text-gray-900 hover:text-primary" href="#">
               Securing Data Integrity: Backup Recovery Systems
              </a>
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-data text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
              <a class="text-base font-semibold text-gray-900 hover:text-primary" href="#">
               Restoration Assurance: Proactive Backup Resources
              </a>
              <p class="text-sm text-gray-700">
