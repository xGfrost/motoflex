...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../">
  <title>
   Metronic - Tailwind CSS Invite a Friend
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/invite-a-friend" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Invite a friend page, using Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Invite a Friend" name="twitter:title"/>
  <meta content="Invite a friend page, using Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/account/invite-a-friend" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Invite a Friend" property="og:title"/>
  <meta content="Invite a friend page, using Tailwind CSS" property="og:description"/>
         ...
         <div class="col-span-2">
          <div class="flex flex-col gap-5 lg:gap-7.5">
           <div class="card">
            ...
            <div class="card-body grid gap-5">
             <div class="flex items-center flex-wrap lg:flex-nowrap gap-2.5">
              <span class="form-label max-w-32 w-full">
               Email
              </span>
              <div class="grow min-w-48">
               <input class="input w-full" placeholder="" type="text" value="jason@studio.io"/>
              </div>
             </div>
             <div class="flex items-baseline flex-wrap gap-2.5">
              ...
              <div class="grid gap-5 grow items-start">
            ...
            <div class="card-header py-5 flex-wrap gap-2">
             ...
             <div class="flex gap-6">
              <div class="relative">
               ...
               <input class="input input-sm ps-8" placeholder="Search Members" type="text"/>
              </div>
              <label class="switch switch-sm">
               ...
               <table class="table table-border" data-datatable-table="true" id="members_table">
                ...
                <tbody>
                 <tr>
                  ...
                  <td>
                   <div class="flex items-center gap-2.5">
                    ...
                    <div class="flex flex-col gap-0.5">
                     <a class="leading-none font-medium text-sm text-gray-900 hover:text-primary" href="html/demo10/network/user-cards/mini-cards.html">
                      Tyler Hero
                     </a>
                  ...
                  <td class="text-center">
                   <span class="badge badge-xs badge-outline badge-success items-center">
                 ...
                 <tr>
                  ...
                  <td class="text-center">
                   <span class="badge badge-xs badge-outline badge-warning items-center">
                 ...
                 <tr>
                  ...
                  <td class="text-center">
                   <span class="badge badge-xs badge-outline badge-danger items-center">
             ...
             <div class="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
              ...
              <div class="flex flex-col items-start grow gap-5">
               <div class="relative w-full">
                <input class="input" name="user_email" placeholder="" type="text" value="https://www.ktstudio.com/RSVP?c=12345XYZt"/>
                <button class="btn btn-clear btn-light btn-icon btn-sm absolute end-0 top-2/4 -translate-y-2/4 me-1.5">
                 <i class="ki-filled ki-copy">
                 </i>
                </button>
               </div>
           ...
           <div class="card">
            ...
            <div class="card-footer justify-center">
             <a class="btn btn-link" href="https://keenthemes.com/contact">
              Contact Support
             </a>
            </div>
           </div>
           ...
           <div class="card">
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-users text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-message-add text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
			...
			39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z" stroke="">
                ...
                <div class="absolute leading-none start-2/4 top-2/4 -translate-y-2/4 -translate-x-2/4 rtl:translate-x-2/4">
                 <i class="ki-filled ki-address-book text-1.5xl ps-px text-brand">
                 </i>
                </div>
               </div>
              </div>
