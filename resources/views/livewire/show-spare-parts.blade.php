    ...
    <div class="flow-root">
        <dl class="-my-3 divide-y divide-gray-200 text-sm dark:divide-gray-700">
            <div class="grid grid-cols-1 gap-1 py-3 sm:grid-cols-3 sm:gap-4">
                ...
                <dd class="text-gray-700 sm:col-span-2 dark:text-gray-200">{{ $spareparts->name }}</dd>
            </div>

            <div class="grid grid-cols-1 gap-1 py-3 sm:grid-cols-3 sm:gap-4">
                <dt class="font-medium text-gray-900 dark:text-white">Workshop</dt>

                <dd class="text-gray-700 sm:col-span-2 dark:text-gray-200">{{ $spareparts->workshop->name ?? '-' }}</dd>
            </div>
            ...
            <div class="grid grid-cols-1 gap-1 py-3 sm:grid-cols-3 sm:gap-4">
                ...
                <dd class="text-gray-700 sm:col-span-2 dark:text-gray-200">
                    Rp{{ number_format($spareparts->price, 0, ',', '.') }}</dd>
            </div>
            ...
            <div class="grid grid-cols-1 gap-1 py-3 sm:grid-cols-3 sm:gap-4">
                <dt class="font-medium text-gray-900 dark:text-white">Stock</dt>
