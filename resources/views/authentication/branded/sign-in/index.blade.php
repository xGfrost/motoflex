...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/authentication/branded/sign-in/index.html" rel="canonical"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/authentication/branded/sign-in/index.html" property="og:url"/>
     ...
     <form action="#" class="card-body flex flex-col gap-5 p-10" id="sign_in_form" method="get">
      <div class="text-center mb-2.5">
       ...
       <div class="flex items-center justify-center font-medium">
        ...
        <a class="text-2sm link" href="html/demo10/authentication/branded/sign-up.html">
         Sign up
        </a>
       </div>
      </div>
      ...
      <div class="flex flex-col gap-1">
       <div class="flex items-center justify-between gap-1">
        ...
        <a class="text-2sm link shrink-0" href="html/demo10/authentication/branded/reset-password/enter-email.html">
         Forgot Password?
        </a>
       </div>
