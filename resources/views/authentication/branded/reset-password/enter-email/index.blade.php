...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/authentication/branded/reset-password/enter-email/index.html" rel="canonical"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/authentication/branded/reset-password/enter-email/index.html" property="og:url"/>
   ...
   <div class="flex justify-center items-center p-8 lg:p-10 order-2 lg:order-1">
    <div class="card max-w-[370px] w-full">
     <form action="#" class="card-body flex flex-col gap-5 p-10" id="reset_password_enter_email_form" method="post">
      ...
      <a class="btn btn-primary flex justify-center grow" href="html/demo10/authentication/branded/reset-password/check-email.html">
       Contoinue
