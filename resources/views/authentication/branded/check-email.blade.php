...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../">
  ...
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/authentication/branded/check-email" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Check email page, using Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Check Email" name="twitter:title"/>
  <meta content="Check email page, using Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/authentication/branded/check-email" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Check Email" property="og:title"/>
  <meta content="Check email page, using Tailwind CSS" property="og:description"/>
    ...
    <div class="card max-w-[440px] w-full">
     <div action="#" class="card-body p-10" id="check_email_form" method="post">
      ...
      <div class="flex items-center justify-center gap-1">
       ...
       <a class="text-xs font-medium link" href="html/demo10/authentication/branded/sign-in.html">
        Resend
       </a>
      </div>
     </div>
