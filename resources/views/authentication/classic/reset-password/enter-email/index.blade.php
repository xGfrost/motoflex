...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../../../">
  <title>
   Metronic - Tailwind CSS Enter Email
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/authentication/classic/reset-password/enter-email/index.html" rel="canonical"/>
  ...
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/authentication/classic/reset-password/enter-email/index.html" property="og:url"/>
  ...
  <div class="flex items-center justify-center grow bg-center bg-no-repeat page-bg">
   <div class="card max-w-[370px] w-full">
    <form action="#" class="card-body flex flex-col gap-5 p-10" id="reset_password_enter_email_form" method="post">
     ...
     <a class="btn btn-primary flex justify-center grow" href="html/demo10/authentication/classic/reset-password/check-email.html">
      Contoinue
