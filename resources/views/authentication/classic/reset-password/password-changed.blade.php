...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../../../">
  <title>
   Metronic - Tailwind CSS Password is Changed
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/authentication/classic/reset-password/password-changed" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Password changed confirmation page, using Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Password is Changed" name="twitter:title"/>
  <meta content="Password changed confirmation page, using Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/authentication/classic/reset-password/password-changed" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Password is Changed" property="og:title"/>
  <meta content="Password changed confirmation page, using Tailwind CSS" property="og:description"/>
   ...
   <div class="card max-w-[440px] w-full">
    <div class="card-body p-10">
     ...
     <div class="flex justify-center">
      <a class="btn btn-primary" href="html/demo10/authentication/classic/sign-in.html">
       Sign in
      </a>
     </div>
    </div>
