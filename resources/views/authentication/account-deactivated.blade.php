...
<html class="h-full" data-theme="true" data-theme-mode="light" dir="ltr" lang="en">
 <head><base href="../../../">
  <title>
   Metronic - Tailwind CSS Account Deactivated
  </title>
  <meta charset="utf-8"/>
  <meta content="follow, index" name="robots"/>
  <link href="https://127.0.0.1:8001/metronic-tailwind-html/demo10/authentication/account-deactivated" rel="canonical"/>
  <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
  <meta content="Account deactivated page, powered by Tailwind CSS" name="description"/>
  <meta content="@keenthemes" name="twitter:site"/>
  <meta content="@keenthemes" name="twitter:creator"/>
  <meta content="summary_large_image" name="twitter:card"/>
  <meta content="Metronic - Tailwind CSS Account Deactivated" name="twitter:title"/>
  <meta content="Account deactivated page, powered by Tailwind CSS" name="twitter:description"/>
  <meta content="assets/media/app/og-image.png" name="twitter:image"/>
  <meta content="https://127.0.0.1:8001/metronic-tailwind-html/demo10/authentication/account-deactivated" property="og:url"/>
  <meta content="en_US" property="og:locale"/>
  <meta content="website" property="og:type"/>
  <meta content="@keenthemes" property="og:site_name"/>
  <meta content="Metronic - Tailwind CSS Account Deactivated" property="og:title"/>
  <meta content="Account deactivated page, powered by Tailwind CSS" property="og:description"/>
    ...
    <div class="flex flex-col grow lg:rounded-l-xl bg-[--tw-content-bg] dark:bg-[--tw-content-bg-dark] border border-gray-300 dark:border-gray-200 lg:ms-[--tw-sidebar-width]">
     <div class="flex flex-col grow lg:scrollable-y-auto lg:[scrollbar-width:auto] lg:light:[--tw-scrollbar-thumb-color:var(--tw-content-scrollbar-color)] pt-5" id="scrollable_content">
      <main class="grow" role="content">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5 lg:gap-7.5">
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           ...
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10/account/members/team-info.html">
             Personal info
            </a>
         ...
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           ...
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10/account/security/security-log.html">
             Login & Security
            </a>
            <span class="text-2sm text-gray-700 leading-5">
         ...
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           ...
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10/account/billing/basic.html">
             Billing & Payments
            </a>
            <span class="text-2sm text-gray-700 leading-5">
         ...
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           ...
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10/account/notifications.html">
             Notifications
            </a>
            <span class="text-2sm text-gray-700 leading-5">
         ...
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           ...
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10/account/integrations.html">
             Integrations
            </a>
            <span class="text-2sm text-gray-700 leading-5">
         ...
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           ...
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10/account/members/roles.html">
             Members, Teams & Roles
            </a>
            <span class="text-2sm text-gray-700 leading-5">
         ...
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           ...
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10/account/api-keys.html">
             API Keys
            </a>
            <span class="text-2sm text-gray-700 leading-5">
         ...
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           ...
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10/account/appearance.html">
             Appearance
            </a>
            <span class="text-2sm text-gray-700 leading-5">
         ...
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           ...
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10.html">
             Devices
            </a>
            <span class="text-2sm text-gray-700 leading-5">
         ...
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           ...
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10/account/invite-a-friend.html">
             Brand
            </a>
            <span class="text-2sm text-gray-700 leading-5">
         ...
         <div class="card p-5 lg:p-7.5 lg:pt-7">
          <div class="flex flex-col gap-4">
           ...
           <div class="flex flex-col gap-3">
            <a class="text-base font-medium leading-none text-gray-900 hover:text-primary-active" href="html/demo10/account/activity.html">
             Activity
            </a>
            <span class="text-2sm text-gray-700 leading-5">
       ...
       <!-- End of Container -->
       <div class="modal" data-modal="true" id="modal_acccount_deactivated">
        <div class="modal-content modal-center max-w-[500px] w-full">
         ...
         <div class="modal-body flex flex-col items-center pt-0 pb-10">
          <div class="mb-9">
           <img alt="image" class="dark:hidden max-h-[150px]" src="assets/media/illustrations/23.svg"/>
           <img alt="image" class="light:hidden max-h-[150px]" src="assets/media/illustrations/23-dark.svg"/>
          </div>
          <h3 class="text-lg font-medium text-gray-900 text-center mb-3">
           Account Deactivated
          </h3>
          <div class="text-2sm text-center text-gray-700 mb-7">
           Your account has been deactivated. Please contact
           <br/>
           support if this is an error or for reactivation.
          </div>
          <a class="btn btn-primary flex justify-center" href="html/demo10.html">
           Go to Home
          </a>
         </div>
        </div>
       ...
       <script>
        window.onload = () => {
		const modalEl = KTDom.getElement('#modal_acccount_deactivated');
